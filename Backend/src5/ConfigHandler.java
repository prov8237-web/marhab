...
public class ConfigHandler extends OsBaseHandler {
    ...
    public void handleClientRequest(User user, ISFSObject params) {
        ...
        // File paths - matching official EXACTLY
        res.putUtfString("itemFile", "data/ifile.1915"); // ✅ تصحيح من 1913 إلى 1915
        res.putUtfString("versionFile", "data/vf.467");
        res.putUtfString("langFile", "locale/ar_AR.702");
        res.putUtfString("webServer", "www.sanalika.com/ar"); // ✅ تصحيح
        ...
        // Room themes - matching official EXACTLY
        ...
        allRoomTheme.addUtfString("blackfriday"); // ✅ تصحيح
        allRoomTheme.addUtfString("valentine");   // ✅ تصحيح
        allRoomTheme.addUtfString("snowLand");    // ✅ تصحيح
