package extensions.notification
{
   ...
   public class BotMessage extends CoreMovieClip implements IBotMessage
   {
      ...
      public function init() : void
      {
         ...
         messageContent = StringUtil.txt2link(StringUtil.wrapHtmlTags(data.message),"ffffff");
      ...
      public function set data(param1:Object) : void
      {
         ...
         {
            if(param1.property.constructor.toString().match(/object/i) != "Object")
            {
