package com.oyunstudyosu.engine.character
{
   ...
   public class Character extends EntryObject implements ICharacter, ISpeechable
   {
      ...
      private var stayIdle:String = "|fybjls09|l870mfna|nsefh7f1|kmcpwccp|u91npebu|gingerg|gingery|gingerb|xzp71ktp|yw012vxx|u05fqv2s|mvc9k8t3|isn7nc1p|q3rgrr1a|8uekoujk|6PMqSV3s|";
      
      private var hizA:String = "|gingerg|";
      
      private var hizB:String = "|gingery|gingerb|gingerb|xzp71ktp|yw012vxx|u05fqv2s|mvc9k8t3|isn7nc1p|q3rgrr1a|g7yu68yh_9|t6rvecre_10|fj187sm0_9|x7uv89cy_7|fj187sm0|j4RgsYof_9|4n8f3knb_8|a6s0ph4p_9|nfsa5mne_6|g3xdx5yc_9|JFxT6Xy3_3|upFUn98T_7|d22VsArn_4|80m5fv8g_3|";
      
      private var hizC:String = "|pfr88a2m_9|fybjls09|ePUV4p7z_9|ePUV4p7z_9|06h36hb2_6|06h36hb2_7|bwaz4889_9|mh2vigh5_9|uGp8nzkH_9|zDydWmia_9|5r797c48_9|";
      
      private var hizD:String = "|l870mfna|nsefh7f1|kmcpwccp|l870mfna|nsefh7f1|kmcpwccp|m7khgfes|8uekoujk|6PMqSV3s|";
      
      private var hizE:String = "|u91npebu|";
      ...
      private var _avatarNick:String;
      ...
      public function set avatarNick(param1:String) : void
      {
         if(_avatarNick == param1)
         {
            return;
         }
         _avatarNick = param1;
      ...
      public function setAccesory(param1:Array) : void
      {
         ...
         for each(var _loc3_ in param1)
         {
            ...
            {
               trace("PlaceBit değerleri çakıştı");
            }
            else
            {
      ...
      public function fill(param1:MovieClip, param2:Boolean = true) : void
      {
         if(type == 0)
         {
      ...
      private function clearContainer(param1:MovieClip) : void
      {
      ...
      public function drawCharWithoutDrawTest(param1:MovieClip) : void
      {
         var _loc12_:int = 0;
      ...
      private function drawCharNormal(param1:MovieClip) : void
      {
         var _loc10_:int = 0;
         var _loc3_:ClothData = null;
      ...
      private function cacheChar(param1:Boolean = false) : void
      {
         ...
         while(_loc7_ < container.numChildren)
         {
            ...
            {
               _loc6_ = _loc2_ as SimpleCachedCharacterClip;
            }
            _loc7_++;
         }
         if(_loc6_)
         ...
         {
            _loc2_ = _invisibleMovieClipList[_loc10_];
            container.addChildAt(_loc2_,_loc10_);
            _loc10_++;
         }
         _invisibleMovieClipList = new Vector.<MovieClip>();
         ...
         try
         {
            ...
            {
               trace("cache new");
               _loc9_ = IdleCacher.cache(this,_loc8_);
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc2_ = container.getChildAt(_loc10_);
                  if(_loc2_.hasOwnProperty("placeBit") && _loc2_.placeBit != ClothType.BIT22_HANDITEM)
                  {
                     _loc5_.push(_loc2_);
                  }
                  _loc10_++;
               ...
               {
                  _invisibleMovieClipList.push(_loc2_);
      ...
      public function terminate(param1:Boolean = true) : void
      {
         ...
         if(type == 0)
         {
            ...
            scene.characterList.splice(scene.characterList.indexOf(this),1);
         }
      ...
      public function walk(param1:int, param2:int, param3:MovieClip = null, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         var _loc9_:Cell;
         if((_loc9_ = scene.getCellAt(param1,0,param2)) == null || !_loc9_.isWalkable(bit) && !((_loc9_.sittable || _loc9_.swimmable || _loc9_.usable) && !_loc9_.isObjectInUse))
         {
            return;
         }
         if(speed >= 100)
         {
            ...
            if(isMe)
            {
               Sanalika.instance.engine.scene.screenShifting();
         ...
         if(_loc9_.sittable || _loc9_.swimmable || _loc9_.usable)
         {
            ...
            if(_loc9_.parentMapEntry.hasReservedGrids)
            {
               ...
               while(_loc11_ < _loc12_)
               {
                  ...
                  {
                     _loc8_ = true;
                     if((_loc10_ = (_loc9_ = scene.getCellAtPoint(_loc13_.grid)).getFrontPos(scene)) == null)
                     {
                        return;
                     }
            ...
            param1 = int(_loc10_.x);
            param2 = int(_loc10_.y);
      ...
      private function reachable(param1:int, param2:int) : Boolean
      {
               ...
               if(isMe)
               {
                  if(gameZoneId == "iceRink")
                  {
                     if(!GamePoolModel.canskateByCloth())
                     {
                        ...
                        _loc3_.description = $("requiredIceScateCloth");
                        Dispatcher.dispatchEvent(new AlertEvent(_loc3_));
                        return false;
                     }
                  }
                  if(gameZoneId == "swimPool")
                  {
                     if(!GamePoolModel.canSwimByCloth())
                     {
                        _loc2_ = new AlertVo();
                        _loc2_.alertType = "Info";
                        _loc2_.description = $("requiredSwimCloth");
      ...
      override public function update() : void
      {
         ...
         if(scenePosition.equals(sceneTarget))
         {
            if(pathIndis <= 0)
            {
               _loc2_ = Boolean(currentTile.equals(targetArrivableTile));
      ...
      public function locate(param1:Number, param2:Number, param3:Number) : void
      {
         ...
         if(cell == null || _loc4_ != cell)
         {
            ...
            _loc5_ = int(scene.gridManager.getAreaNoFromGrid(cell.x,cell.y));
      ...
      public function reLocate(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         var _loc5_:Cell;
         if((_loc5_ = scene.getCellAt(param1,0,param2)) == null || _loc5_.parentMapEntry == null && _loc5_.cellType != CellType.TYPE_EMPTY && !(_loc5_.cellType == CellType.TYPE_SANALIKAX && Boolean(Sanalika.instance.avatarModel.permission.check(32))) && !(_loc5_.cellType == CellType.TYPE_DIAMOND && Boolean(Sanalika.instance.avatarModel.permission.check(14))) && !(_loc5_.cellType == CellType.TYPE_ADMIN && Boolean(Sanalika.instance.avatarModel.permission.check(20))))
         {
         ...
         var _loc7_:int = int(scene.gridManager.getAreaNoFromGrid(_loc5_.x,_loc5_.y));
         if(status == "s")
         {
            _loc7_++;
         }
      ...
      public function setAction(param1:String) : void
      {
         ...
         var _loc3_:int = 0;
         trace("setAction() : newAction[" + param1 + "] : ME[" + Sanalika.instance.avatarModel.avatarNick + "] ID[" + id + "]");
         if(isMe && param1 != action)
         {
            action = param1;
            Sanalika.instance.serviceModel.setUserVariable(["status"],[param1]);
            trace("changeVarStatus",param1);
         }
         else
         {
            _loc2_ = Sanalika.instance.engine.scene.elementsContainer.getChildByName(gameZoneId) as GamePool;
            if(_loc2_ != null && !isMe)
            {
               this.disableChar();
            }
         ...
         if(param1 == "d")
         {
            ...
            {
               _loc3_ = _direction <= 4 ? 3 : 5;
               setStatus("d",_loc3_);
               if(isMe)
               {
                  Sanalika.instance.serviceModel.setUserVariable(["direction"],[_loc3_]);
               }
            }
            this.action = param1;
         }
      ...
      private function patchClothSystem4HandItem() : void
      {
         ...
         if(isMe)
         {
            _loc3_ = String(Sanalika.instance.avatarModel.holdedItem);
         }
         else
         {
         ...
         var _loc6_:int = int(_loc8_.itemType);
         if(status == "d" && Boolean(ItemType.isItemVisibleDance(_loc6_)))
         {
            _loc1_ = status;
            setStatus("i",_direction);
            status = _loc1_;
      ...
      public function canIUseHandItem() : Boolean
      {
         ...
         while(_loc3_ < container.numChildren)
         {
            _loc1_ = MovieClip(container.getChildAt(_loc3_));
            if(_loc1_.hasOwnProperty("placeBit"))
            {
      ...
      public function disableChar() : void
      {
         ...
         var _loc1_:GamePool = Sanalika.instance.engine.scene.elementsContainer.getChildByName(gameZoneId) as GamePool;
         if(_loc1_ != null)
         {
         ...
         if(isMe)
         {
            scene.screenShiftTo(this.container.x,this.container.y);
         }
      }
      ...
      public function setStatus(param1:String, param2:int) : void
      {
         ...
         {
            _loc3_ = container.getChildAt(_loc6_);
         ...
         else
         {
            ...
            while(_loc6_ < container.numChildren)
            {
               ...
               if(_loc3_.hasOwnProperty("placeBit"))
               {
                  if(_loc3_.placeBit != ClothType.BIT22_HANDITEM)
                  {
                     if(param1 == "i" && Boolean(ItemType.isHandVisibleIdle(_loc4_)))
                     {
                        updateMcStatus(_loc3_,"k",param1,param2);
                     }
                     else if(param1 == "w" && Boolean(ItemType.isHandVisibleWalking(_loc4_)))
                     {
                        if(stayIdle.indexOf("|" + holdedItemKey + "|") > -1)
                        {
                     ...
                     else if(param1 == "s" && Boolean(ItemType.isHandVisibleSitting(_loc4_)))
                     {
                        updateMcStatus(_loc3_,"k",param1,param2);
                     }
                     else
