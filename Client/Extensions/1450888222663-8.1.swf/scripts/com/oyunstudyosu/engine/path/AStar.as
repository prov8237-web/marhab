package com.oyunstudyosu.engine.path
{
   ...
   public class AStar
   {
      ...
      public function solve() : Vector.<IntPoint>
      {
         ...
         var _loc4_:int = start.y * width + start.x;
         var _loc6_:int = goal.y * width + goal.x;
         if(_loc4_ == _loc6_)
         {
         ...
         while(!_loc1_)
         {
            ...
            {
               processNeighbours(_loc3_.shift(),_loc7_,_loc3_);
               _loc11_++;
            }
            _loc11_ = 0;
            while(_loc11_ < _loc3_.length)
            {
               if(_loc3_[_loc11_] == _loc6_)
               {
                  _loc1_ = true;
                  break;
               }
         ...
         while(_loc5_ != _loc4_)
         {
            _loc5_ = minimumKomsuBul(_loc5_,_loc7_);
            _loc8_.unshift(_loc5_);
         }
         var _loc10_:Vector.<IntPoint> = new Vector.<IntPoint>();
         _loc11_ = 0;
         while(_loc11_ < _loc8_.length)
         {
            _loc10_.unshift(new IntPoint(_loc8_[_loc11_] % width,_loc8_[_loc11_] / width));
            _loc11_++;
         }
         if(_loc10_.length == 0)
         {
