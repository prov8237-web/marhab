package com.oyunstudyosu.model
{
   ...
   public class CacheModel
   {
      ...
      {
         super();
         if(param1.loaderInfo.applicationDomain.hasDefinition("com.oyunstudyosu.air.controller.CacheController"))
         {
            CacheController = param1.loaderInfo.applicationDomain.getDefinition("com.oyunstudyosu.air.controller.CacheController") as Class;
         }
      }
