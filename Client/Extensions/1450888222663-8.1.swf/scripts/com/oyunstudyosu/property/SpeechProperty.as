package com.oyunstudyosu.property
{
   ...
   public class SpeechProperty extends Property
   {
      ...
      private function talk(param1:String) : void
      {
         ...
         var _loc2_:ISpeechable = Sanalika.instance.engine.scene.getBotByName(data.metaKey);
         if(_loc2_)
         {
            _loc2_.talk(printf(param1,Sanalika.instance.avatarModel.avatarName));
            lastMessage = param1;
         }
      }
      ...
      {
         var _loc1_:int = int(NumberUtils.randRange(10,40));
      ...
      private function listenSpeechEvents(param1:BotEvent) : void
      {
         ...
         if(list[param1.speechType])
         {
            ...
            {
               _loc2_ = int(NumberUtils.randRange(0,list[param1.speechType].length - 1));
               talk(printf(list[param1.speechType][_loc2_],Sanalika.instance.avatarModel.avatarName));
            }
         }
      }
