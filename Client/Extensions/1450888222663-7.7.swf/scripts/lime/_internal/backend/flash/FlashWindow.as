   ...
   public class FlashWindow
   {
      ...
      public function handleKeyEvent(param1:KeyboardEvent) : void
      {
         ...
         if(param1.type == KeyboardEvent.KEY_DOWN)
         {
            ...
            if(parent.__backend.getTextInputEnabled())
            {
               ...
               parent.onTextInput.dispatch(_loc4_ < 65536 ? String["fromCharCode"](_loc4_) : String(Boot.fromCodePoint(_loc4_)));
            }
         }
         else
         {
      ...
      public function create() : void
      {
         ...
         if(FlashApplication.createFirstWindow)
         {
            ...
            if(!!Reflect.hasField(_loc1_,"context") && Boolean(Reflect.hasField(_loc1_.context,"background")) && _loc1_.context.background != null)
            {
