package lime.utils
{
   ...
   public class Log
   {
      ...
      public static function debug(param1:*, param2:Object = undefined) : void
      {
         ...
         if(Log.level >= 4)
         {
            _loc3_ = "[" + String(param2.className) + "] " + String(Std.string(param1));
            trace(String(Std.string(_loc3_)));
         }
      }
      ...
      public static function error(param1:*, param2:Object = undefined) : void
      {
         ...
         if(Log.level >= 1)
         {
            _loc3_ = "[" + String(param2.className) + "] ERROR: " + String(Std.string(param1));
            if(Log.throwErrors)
            {
      ...
      {
         trace(String(Std.string(param1)));
      }
      ...
      public static function warn(param1:*, param2:Object = undefined) : void
      {
         ...
         if(Log.level >= 2)
         {
            _loc3_ = "[" + String(param2.className) + "] WARNING: " + String(Std.string(param1));
            trace(String(Std.string(_loc3_)));
         }
      }
   }
