package extensions.notification
{
   ...
   public class UserRoomMessage extends BotMessage
   {
      ...
      override public function init() : void
      {
         ...
         message = String(StringUtil.removeCarriageReturnsAndNewLines(data.message));
         ...
         if(Sanalika.instance.engine.scene != null && Boolean(Sanalika.instance.engine.scene.existsComponent(SceneCharacterComponent)))
         {
         ...
         if(character != null && Boolean(character.isMe))
         {
      ...
      private function clickReport(param1:Event = null) : void
      {
         ...
         if(character != null && data.message != null && !Sanalika.instance.avatarModel.guest)
         {
            ...
            _loc2_.type = "hud";
            _loc2_.params = {};
            _loc2_.params.sender = character;
