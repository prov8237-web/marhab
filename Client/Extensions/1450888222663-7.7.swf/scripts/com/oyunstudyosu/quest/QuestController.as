   ...
   public class QuestController
   {
      ...
      private function collectGroundObject(param1:GameEvent) : void
      {
         ...
         while(_loc6_ < groundVos.length)
         {
            ...
            if(groundVos[_loc6_].posX == parseInt(_loc2_[0]) && groundVos[_loc6_].posY == parseInt(_loc2_[1]) || Boolean(groundObject.container.hitTestObject(_loc3_.myChar.container)))
            {
               if(groundObject)
               {
                  if(requiredHandItem)
