package com.oyunstudyosu.model
{
   ...
   public class HudModel implements IHudModel
   {
      ...
      private function manualLeftDirection() : void
      {
         ...
         if(getTimer() > lastTime + 1200 && Boolean(Sanalika.instance.engine.scene.existsComponent(SceneCharacterComponent)))
         {
      ...
      public function onSceneResize(param1:GameEvent) : void
      {
         ...
         if(Sanalika.instance.scaleModel.isLandscape && hud.menuBg.width > 780 * Sanalika.instance.scaleModel.uiScale || Boolean(Sanalika.instance.airModel.isDesktop()))
         {
            if(Sanalika.instance.airModel.isMobile())
            {
