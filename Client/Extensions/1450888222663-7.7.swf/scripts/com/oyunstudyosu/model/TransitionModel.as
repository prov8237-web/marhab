package com.oyunstudyosu.model
{
   ...
   public class TransitionModel
   {
      ...
      protected function fadeOut(param1:Event) : void
      {
         ...
         state = 2;
         var _loc5_:Number = Number(com.oyunstudyosu.§model:TransitionModel§.layerModel.gameLayer.x);
         var _loc4_:Number = Number(com.oyunstudyosu.§model:TransitionModel§.layerModel.gameLayer.y);
