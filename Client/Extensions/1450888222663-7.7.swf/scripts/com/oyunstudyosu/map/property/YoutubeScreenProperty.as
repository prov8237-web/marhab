package com.oyunstudyosu.map.property
{
   ...
   public class YoutubeScreenProperty extends MapProperty
   {
      ...
      private function onSceneLoaded(param1:GameEvent) : void
      {
         ...
         room = Sanalika.instance.serviceModel.sfs.lastJoinedRoom;
      ...
      {
         var _loc2_:int = int(this.entry.width);
         var _loc4_:Number = Number(this.entry.height);
         var _loc5_:int = int(this.entry.x);
         var _loc3_:int = int(this.entry.y);
      ...
      {
         var _loc1_:int = int(this.entry.width);
         var _loc3_:Number = Number(this.entry.height);
         var _loc4_:int = int(this.entry.x);
         var _loc2_:int = int(this.entry.y);
