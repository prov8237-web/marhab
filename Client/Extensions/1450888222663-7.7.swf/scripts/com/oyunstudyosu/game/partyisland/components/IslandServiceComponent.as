package com.oyunstudyosu.game.partyisland.components
{
   ...
   public class IslandServiceComponent extends BaseSceneComponent
   {
      ...
      {
         Sanalika.instance.serviceModel.listenExtension("turn",onTurn);
         Sanalika.instance.serviceModel.listenExtension("dice",onDice);
         Sanalika.instance.serviceModel.listenExtension("gameState",onGameState);
         Sanalika.instance.serviceModel.listenExtension("joinStatus",onJoinStatus);
         Sanalika.instance.serviceModel.listenExtension("property",onProperty);
         Sanalika.instance.serviceModel.listenExtension("gameCanceled",onGameCancelled);
      ...
      {
         var _loc1_:* = Sanalika.instance.serviceModel.sfs.lastJoinedRoom;
      ...
      {
         Sanalika.instance.serviceModel.requestData("partyIsland.leave",{},null,Sanalika.instance.serviceModel.sfs.lastJoinedRoom);
      }
      
      override public function dispose() : void
      {
         Dispatcher.removeEventListener("SCENE_LOADED",sceneLoaded);
         Sanalika.instance.serviceModel.removeExtension("turn",onTurn);
         Sanalika.instance.serviceModel.removeExtension("dice",onDice);
         Sanalika.instance.serviceModel.removeExtension("gameState",onGameState);
         Sanalika.instance.serviceModel.removeExtension("joinStatus",onJoinStatus);
         Sanalika.instance.serviceModel.removeExtension("property",onProperty);
         Sanalika.instance.serviceModel.removeExtension("gameCanceled",onGameCancelled);
