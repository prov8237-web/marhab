package com.oyunstudyosu.game.partyisland.components
{
   ...
   public class IslandSceneHudComponent extends BaseSceneComponent
   {
      ...
      private function onLeaveGameButtonClick(param1:MouseEvent) : void
      {
         ...
         if(sceneCharacterComponent != null && sceneCharacterComponent.myChar != null && !sceneCharacterComponent.myChar.isSpectator && islandServiceComponent != null && islandServiceComponent.isGameStarted() && !islandServiceComponent.isGameEnded())
         {
            vo = new AlertVo();
      ...
      {
         var _loc2_:Number = Number(Sanalika.instance.scaleModel.uiScale);
      ...
      private function onDiceButtonClick(param1:MouseEvent) : void
      {
         ...
         Sanalika.instance.serviceModel.requestData("partyIsland.rollDice",{},null,Sanalika.instance.serviceModel.sfs.lastJoinedRoom);
      }
