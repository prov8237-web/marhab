package com.oyunstudyosu.engine.character
{
   ...
   public class Character extends EntryObject implements ICharacter, ISpeechable
   {
      ...
      public function set avatarName(param1:String) : void
      {
         ...
         param1 = String(StringUtil.wrapHtmlTags(param1));
         _avatarName = param1;
      }
      ...
      public function walk(param1:int, param2:int, param3:MovieClip = null, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         var _loc9_:Cell;
         if((_loc9_ = scene.getCellAt(param1,0,param2)) == null || !_loc9_.isWalkable(this) && !((_loc9_.sittable || Boolean(_loc9_.swimmable) || Boolean(_loc9_.usable)) && !_loc9_.isObjectInUse))
         {
            return;
         }
         if(speed >= 100)
         ...
         if(_loc9_.sittable || Boolean(_loc9_.swimmable) || Boolean(_loc9_.usable))
         {
            _loc10_ = null;
      ...
      public function updateTargetCellSettings(param1:Cell) : Boolean
      {
         ...
         if(param1.sittable || Boolean(param1.swimmable) || Boolean(param1.usable))
         {
      ...
      public function locate(param1:Number, param2:Number, param3:Number) : void
      {
         ...
         if(cell == null || _loc4_ != cell)
         {
            ...
            cell = _loc4_;
            if(_loc4_.sittable || Boolean(_loc4_.usable))
            {
               _loc4_.isObjectInUse = true;
            }
            if((_loc5_ = int(scene.gridManager.getAreaNoFromGrid(cell.x,cell.y))) == -1)
            {
               trace(this.avatarName + "\'s newNumberedCharArrayIndex is -1");
            }
            if(status == "s" || Boolean(_loc4_.isObjectInUse))
            {
               _loc5_++;
            }
      ...
      public function reLocate(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         this.reCalcLastXY();
         if(_loc5_.sittable || Boolean(_loc5_.usable))
         {
      ...
      public function setSmiley(param1:String) : void
      {
         ...
         if(smileyContainer != null && Boolean(container.contains(smileyContainer)))
         {
