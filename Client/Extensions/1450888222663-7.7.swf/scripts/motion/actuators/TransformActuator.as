package motion.actuators
{
   ...
   public class TransformActuator extends SimpleActuator
   {
      ...
      {
         if(!!Reflect.hasField(properties,"colorValue") && Boolean(Std.isOfType(target,DisplayObject)))
         {
            initializeColor();
         }
         if(Reflect.hasField(properties,"soundVolume") || Boolean(Reflect.hasField(properties,"soundPan")))
         {
            initializeSound();
         }
