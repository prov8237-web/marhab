package feathers.controls
{
   ...
   public class Callout extends FeathersControl
   {
      ...
      override public function update() : void
      {
         ...
         var _loc2_:Boolean = Boolean(isInvalid(Callout.INVALIDATION_FLAG_ORIGIN));
         var _loc3_:Boolean = Boolean(isInvalid(InvalidationFlag.SIZE));
         var _loc4_:Boolean = Boolean(isInvalid(InvalidationFlag.STATE));
         var _loc5_:Boolean = Boolean(isInvalid(InvalidationFlag.STYLES));
         if(_loc3_)
         {
      ...
      {
         if(!Boolean(setStyle("topArrowSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("topArrowGap")))
         {
      ...
      {
         if(!Boolean(setStyle("rightArrowSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("rightArrowGap")))
         {
      ...
      {
         if(!Boolean(setStyle("marginRight")))
         {
      ...
      {
         if(!Boolean(setStyle("marginLeft")))
         {
            return __marginLeft;
         }
      ...
      {
         if(!Boolean(setStyle("marginBottom")))
         {
      ...
      {
         if(!Boolean(setStyle("leftArrowSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("leftArrowGap")))
         {
      ...
      {
         if(!Boolean(setStyle("bottomArrowSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("bottomArrowGap")))
         {
      ...
      {
         if(!Boolean(setStyle("arrowPosition")))
         {
      ...
      public function measureWithArrowPosition(param1:RelativePosition) : Boolean
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc19_ != null)
            {
               _loc22_ = Number(_loc19_.get_minWidth());
            }
            ...
            if(_loc15_ != null)
            {
               _loc23_ = Number(_loc15_.get_minWidth());
            }
         ...
         if(_loc5_)
         {
            ...
            if(_loc15_ != null)
            {
               _loc23_ = Number(_loc15_.get_minHeight());
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         return Boolean(saveMeasurements(_loc21_,_loc24_,_loc25_,_loc26_,_loc27_,_loc28_));
      }
