package feathers.controls
{
   ...
   public class LayoutGroup extends FeathersControl
   {
      ...
      {
         _ignoreChangesButSetFlags = false;
         var _loc1_:Boolean = Boolean(isInvalid(InvalidationFlag.LAYOUT));
         var _loc2_:Boolean = Boolean(isInvalid(InvalidationFlag.SIZE));
         var _loc3_:Boolean = Boolean(isInvalid(InvalidationFlag.STYLES));
      ...
      public function handleManualLayout() : void
      {
         ...
         while(_loc4_ < int(_loc5_.length))
         {
            ...
            _loc4_++;
            if(!(_loc6_ is ILayoutObject && !Boolean(_loc6_.get_includeInLayout())))
            {
