package feathers.controls.supportClasses
{
   ...
   public class BaseScrollContainer extends FeathersControl implements IFocusObject
   {
      ...
      {
         if(_ignoreViewPortResizing || !!MathUtil.fuzzyEquals(Number(_viewPort.width),_previousViewPortWidth) && Boolean(MathUtil.fuzzyEquals(Number(_viewPort.height),_previousViewPortHeight)))
         {
            return;
         }
      ...
      {
         var _loc1_:Boolean = Boolean(isInvalid(InvalidationFlag.STYLES));
         var _loc2_:Boolean = Boolean(isInvalid(InvalidationFlag.SIZE));
         var _loc3_:Boolean = Boolean(isInvalid(InvalidationFlag.STATE));
         var _loc4_:Boolean = Boolean(isInvalid(BaseScrollContainer.INVALIDATION_FLAG_SCROLLER_FACTORY));
         var _loc5_:Boolean = Boolean(isInvalid(BaseScrollContainer.INVALIDATION_FLAG_SCROLL_BAR_FACTORY));
      ...
      {
         if(!Boolean(setStyle("viewPortMaskSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("showScrollBars")))
         {
      ...
      {
         if(!Boolean(setStyle("showScrollBarMinimumDuration")))
         {
      ...
      {
         if(!Boolean(setStyle("scrollPixelSnapping")))
         {
      ...
      {
         if(!Boolean(setStyle("scrollBarYPosition")))
         {
      ...
      {
         if(!Boolean(setStyle("scrollBarXPosition")))
         {
      ...
      {
         if(!Boolean(setStyle("paddingTop")))
         {
            return __paddingTop;
         }
      ...
      {
         if(!Boolean(setStyle("paddingRight")))
         {
      ...
      {
         if(!Boolean(setStyle("paddingLeft")))
         {
      ...
      {
         if(!Boolean(setStyle("paddingBottom")))
         {
      ...
      {
         if(!Boolean(setStyle("hideScrollBarEase")))
         {
      ...
      {
         if(!Boolean(setStyle("hideScrollBarDuration")))
         {
      ...
      {
         if(!Boolean(setStyle("fixedScrollBars")))
         {
      ...
      {
         if(!Boolean(setStyle("disabledBackgroundSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("backgroundSkin")))
         {
      ...
      {
         if(!Boolean(setStyle("autoHideScrollBars")))
         {
      ...
      public function refreshViewPort() : void
      {
         ...
         throw new IllegalOperationError(String(Type.getClassName(Type.getClass(this))) + " stuck in an infinite loop during measurement and validation. This may be an issue with the layout or children, such as custom item renderers.");
      }
      ...
      public function refreshScrollRect() : void
      {
         ...
         {
            _loc3_ = Number(DisplayUtil.getConcatenatedScaleX(this));
            _loc4_ = Number(DisplayUtil.getConcatenatedScaleY(this));
         ...
         else
         {
            ...
            {
               throw new ArgumentError("Unknown scrollMode: " + String(Std.string(_scrollMode)));
            }
            _loc6_ = _scrollRect1;
      ...
      {
         if(!(!!isInvalid(InvalidationFlag.SCROLL) && needsScrollMeasurement() || Boolean(isInvalid(InvalidationFlag.DATA)) || Boolean(isInvalid(InvalidationFlag.SIZE)) || Boolean(isInvalid(InvalidationFlag.STYLES)) || Boolean(isInvalid(BaseScrollContainer.INVALIDATION_FLAG_SCROLL_BAR_FACTORY)) || Boolean(isInvalid(InvalidationFlag.STATE))))
         {
            return Boolean(isInvalid(InvalidationFlag.LAYOUT));
         }
         return true;
      }
      ...
      public function measure() : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc10_ = Math.max(_loc10_,Number(_loc7_.get_minWidth()));
            }
         ...
         if(_loc4_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc11_ = Math.max(_loc11_,Number(_loc7_.get_minHeight()));
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc5_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc12_ = Math.min(_loc12_,Number(_loc7_.get_maxWidth()));
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc6_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc13_ = Math.min(_loc13_,Number(_loc7_.get_maxHeight()));
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         return Boolean(saveMeasurements(_loc8_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_));
      }
      ...
      override public function get tabEnabled() : Boolean
      {
         ...
         {
            return Boolean(get_rawTabEnabled());
         }
         return false;
      }
      ...
      public function calculateViewPortOffsetsForFixedScrollBarY(param1:Boolean, param2:Boolean) : void
      {
         ...
         if(scrollBarY != null && (get_measureViewPort() || param2))
         {
            ...
            if(param1 || _scrollPolicyY == ScrollPolicy.ON || (_loc5_ > _loc3_ && !Boolean(MathUtil.fuzzyEquals(_loc5_,_loc3_)) || _loc4_ != null && _loc5_ > _loc4_ && !Boolean(MathUtil.fuzzyEquals(_loc5_,_loc4_))) && _scrollPolicyY != ScrollPolicy.OFF)
            {
               showScrollBarY = true;
               if(get_fixedScrollBars())
               {
      ...
      public function calculateViewPortOffsetsForFixedScrollBarX(param1:Boolean, param2:Boolean) : void
      {
         ...
         if(scrollBarX != null && (get_measureViewPort() || param2))
         {
            ...
            if(param1 || _scrollPolicyX == ScrollPolicy.ON || (_loc5_ > _loc3_ && !Boolean(MathUtil.fuzzyEquals(_loc5_,_loc3_)) || _loc4_ != null && _loc5_ > _loc4_ && !Boolean(MathUtil.fuzzyEquals(_loc5_,_loc4_))) && _scrollPolicyX != ScrollPolicy.OFF)
            {
               showScrollBarX = true;
               if(get_fixedScrollBars())
               {
      ...
      public function baseScrollContainer_scroller_scrollStartHandler(param1:ScrollEvent) : void
      {
         ...
         if(scroller.get_touchPointIsSimulated())
         {
            ...
            if(!(_loc4_ = Boolean(_loc3_.claimMouse(this))))
            {
               scroller.stop();
               return;
            }
         ...
         {
            _loc3_ = ExclusivePointer.forStage(stage);
            if(!(_loc4_ = Boolean(_loc3_.claimTouch(_loc2_,this))))
            {
               scroller.stop();
               return;
            }
