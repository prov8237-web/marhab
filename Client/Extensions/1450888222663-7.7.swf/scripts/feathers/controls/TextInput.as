package feathers.controls
{
   ...
   public class TextInput extends FeathersControl implements IStageFocusDelegate, ITextControl, IStateContext
   {
      ...
      {
         var _loc1_:Boolean = Boolean(isInvalid(InvalidationFlag.DATA));
         var _loc2_:Boolean = Boolean(isInvalid(InvalidationFlag.SCROLL));
         var _loc3_:Boolean = Boolean(isInvalid(InvalidationFlag.SELECTION));
         var _loc4_:Boolean = Boolean(isInvalid(InvalidationFlag.SIZE));
         var _loc5_:Boolean = Boolean(isInvalid(InvalidationFlag.STATE));
         var _loc6_:Boolean = Boolean(isInvalid(InvalidationFlag.STYLES));
         ...
         var _loc7_:Boolean = Boolean(isInvalid(TextInput.INVALIDATION_FLAG_ERROR_CALLOUT_FACTORY));
         _updatedTextStyles = false;
         _updatedPromptStyles = false;
         if(_loc7_ || _loc1_)
         {
      ...
      {
         if(!Boolean(setStyle("verticalAlign")))
         {
      ...
      {
         if(!Boolean(setStyle("textFormat")))
         {
            return __textFormat;
         }
      ...
      {
         if(!Boolean(setStyle("rightViewGap")))
         {
      ...
      {
         if(!Boolean(setStyle("promptTextFormat")))
         {
      ...
      {
         if(!Boolean(setStyle("leftViewGap")))
         {
      ...
      {
         if(!Boolean(setStyle("embedFonts")))
         {
            return __embedFonts;
         }
      ...
      {
         if(!Boolean(setStyle("disabledTextFormat")))
         {
      ...
      {
         if(!Boolean(setStyle("customErrorCalloutVariant")))
         {
      ...
      {
         if(!Boolean(setStyle("autoSizeWidth")))
         {
      ...
      {
         if(!Boolean(setStyle("setTextFormatForState",param1)))
         {
            return;
         }
         if(param2 == null)
      ...
      {
         if(!Boolean(setStyle("setSkinForState",param1)))
         {
            return;
         }
      ...
      public function refreshPrompt() : void
      {
         ...
         if(promptTextField == null)
         {
            ...
            addChildAt(promptTextField,int(getChildIndex(textField)));
         }
      ...
      public function measure() : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc10_ != null)
            {
               _loc14_ += Number(_loc10_.get_minWidth()) + get_leftViewGap();
            }
            else if(_leftViewMeasurements != null)
            {
            ...
            if(_loc11_ != null)
            {
               _loc14_ += Number(_loc11_.get_minWidth()) + get_rightViewGap();
            }
            else if(_rightViewMeasurements != null)
            {
            ...
            if(_loc7_ != null)
            {
               _loc14_ = Math.max(Number(_loc7_.get_minWidth()),_loc14_);
            }
         ...
         if(_loc4_)
         {
            ...
            if(_loc10_ != null && _loc15_ < Number(_loc10_.get_minHeight()))
            {
               _loc15_ = Number(_loc10_.get_minHeight());
            }
            else if(_leftViewMeasurements != null && _loc15_ < _leftViewMeasurements.minHeight)
            {
               _loc15_ = _leftViewMeasurements.minHeight;
            }
            if(_loc11_ != null && _loc15_ < Number(_loc11_.get_minHeight()))
            {
               _loc15_ = Number(_loc11_.get_minHeight());
            }
            ...
            if(_loc7_ != null)
            {
               _loc15_ = Math.max(Number(_loc7_.get_minHeight()),_loc15_);
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc5_)
         {
            if(_loc7_ != null)
            {
               _loc16_ = Number(_loc7_.get_maxWidth());
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc6_)
         {
            if(_loc7_ != null)
            {
               _loc17_ = Number(_loc7_.get_maxHeight());
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         return Boolean(saveMeasurements(_loc12_,_loc13_,_loc14_,_loc15_,_loc16_,_loc17_));
      }
      ...
      public function createErrorCallout() : void
      {
         ...
         if(String(errorStringCallout.get_variant()) == null)
         {
