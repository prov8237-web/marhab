package feathers.controls
{
   ...
   public class Button extends BasicButton implements IFocusObject, IHTMLTextControl, ITextControl
   {
      ...
      {
         if(!Boolean(setStyle("textOffsetY")))
         {
      ...
      {
         if(!Boolean(setStyle("textOffsetX")))
         {
      ...
      {
         if(!Boolean(setStyle("styleSheet")))
         {
            return __styleSheet;
         }
      ...
      {
         if(!Boolean(setStyle("iconPosition")))
         {
      ...
      {
         if(!Boolean(setStyle("iconOffsetY")))
         {
      ...
      {
         if(!Boolean(setStyle("iconOffsetX")))
         {
      ...
      {
         if(!Boolean(setStyle("horizontalAlign")))
         {
      ...
      {
         if(!Boolean(setStyle("setIconForState",param1)))
         {
            return;
         }
      ...
      public function refreshTextFieldDimensions(param1:Boolean) : void
      {
         ...
         var _loc5_:Number = Number(actualWidth);
         var _loc6_:Number = Number(actualHeight);
         if(param1)
         {
            _loc5_ = 0;
      ...
      override public function measure() : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc9_ != null)
            {
               _loc12_ = Math.max(Number(_loc9_.get_minWidth()),_loc12_);
            }
         ...
         if(_loc4_)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = Math.max(Number(_loc9_.get_minHeight()),_loc13_);
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc5_)
         {
            if(_loc9_ != null)
            {
               _loc14_ = Number(_loc9_.get_maxWidth());
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc6_)
         {
            if(_loc9_ != null)
            {
               _loc15_ = Number(_loc9_.get_maxHeight());
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         return Boolean(saveMeasurements(_loc10_,_loc11_,_loc12_,_loc13_,_loc14_,_loc15_));
      }
      ...
      override public function commitChanges() : void
      {
         ...
         var _loc4_:Boolean = Boolean(isInvalid(InvalidationFlag.STYLES));
         _updatedTextStyles = false;
         if(_loc4_ || _loc3_)
         {
            refreshIcon();
      ...
      public function addCurrentIcon(param1:DisplayObject) : void
      {
         ...
         var _loc2_:int = int(getChildIndex(textField));
