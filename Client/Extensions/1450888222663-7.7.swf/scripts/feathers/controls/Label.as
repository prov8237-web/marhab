package feathers.controls
{
   ...
   public class Label extends FeathersControl implements IStageFocusDelegate, IFocusObject, IHTMLTextControl, ITextControl
   {
      ...
      override public function update() : void
      {
         ...
         var _loc2_:Boolean = Boolean(isInvalid(InvalidationFlag.SELECTION));
      ...
      {
         var _loc1_:Boolean = _selectable && Boolean(_enabled);
      ...
      public function measure() : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc10_ = Math.max(Number(_loc7_.get_minWidth()),_loc10_);
            }
         ...
         if(_loc4_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc11_ = Math.max(Number(_loc7_.get_minHeight()),_loc11_);
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc5_)
         {
            if(_loc7_ != null)
            {
               _loc12_ = Number(_loc7_.get_maxWidth());
            }
            else if(_backgroundSkinMeasurements != null)
            {
         ...
         if(_loc6_)
         {
            if(_loc7_ != null)
            {
               _loc13_ = Number(_loc7_.get_maxHeight());
            }
            else if(_backgroundSkinMeasurements != null)
            {
      ...
      {
         if(_selectable && Boolean(_enabled))
         {
