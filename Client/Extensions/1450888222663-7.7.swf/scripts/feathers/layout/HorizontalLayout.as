package feathers.layout
{
   ...
   public class HorizontalLayout extends EventDispatcher implements ILayout
   {
      ...
      public function validateItems(param1:Array, param2:Measurements) : void
      {
         ...
         var _loc12_:* = null as HorizontalLayoutData;
         var _loc13_:Number = NaN;
         var _loc3_:* = _verticalAlign == VerticalAlign.JUSTIFY;
         var _loc4_:Object;
         ...
         while(_loc6_ < int(param1.length))
         {
            ...
            {
               if(!Boolean((_loc10_ = _loc7_).get_includeInLayout()))
               {
                  continue;
               }
               if((_loc12_ = (_loc11_ = _loc10_.get_layoutData()) as HorizontalLayoutData) != null)
               {
            ...
            else if(_loc5_ != null)
            {
               if(_loc9_ != null)
               {
                  ...
                  _loc7_.height = _loc5_ * (_loc9_ / 100);
               }
            }
            else if(_loc9_ != null && _percentHeightResetEnabled && _loc7_ is IMeasureObject)
            {
               _loc7_.resetHeight();
            }
            if(_loc8_ != null && _percentWidthResetEnabled && _loc4_ == null && _loc7_ is IMeasureObject)
            {
               _loc7_.resetWidth();
            }
            ...
            if(_loc3_ && _loc5_ == null && param2.maxHeight != null)
            {
               _loc13_ = param2.maxHeight - _paddingTop - _paddingBottom;
               if(_loc7_.height > _loc13_)
               {
      ...
      public function layout(param1:Array, param2:Measurements, param3:LayoutBoundsResult = undefined) : LayoutBoundsResult
      {
         ...
         var _loc15_:* = null as HorizontalLayoutData;
         ...
         var _loc6_:* = _verticalAlign == VerticalAlign.JUSTIFY;
         var _loc7_:Object;
         ...
         while(_loc9_ < int(param1.length))
         {
            ...
            {
               if(!Boolean((_loc13_ = _loc10_).get_includeInLayout()))
               {
                  continue;
               }
               if((_loc15_ = (_loc14_ = _loc13_.get_layoutData()) as HorizontalLayoutData) != null)
               {
            ...
            else if(_loc8_ != null)
            {
               if(_loc12_ != null)
               {
                  ...
                  _loc10_.height = _loc8_ * (_loc12_ / 100);
               }
            }
            else if(_loc12_ != null && _percentHeightResetEnabled && _loc10_ is IMeasureObject)
            {
               _loc10_.resetHeight();
            }
            if(_loc11_ != null && _percentWidthResetEnabled && _loc7_ == null && _loc10_ is IMeasureObject)
            {
               _loc10_.resetWidth();
            }
            ...
            if(_loc6_ && _loc8_ == null && param2.maxHeight != null)
            {
               _loc16_ = param2.maxHeight - _paddingTop - _paddingBottom;
               if(_loc10_.height > _loc16_)
               {
                  _loc10_.height = _loc16_;
                  if(_loc10_ is IValidating)
                  {
                     _loc10_.validateNow();
                  }
         ...
         applyPercentWidth(param1,param2.width,param2.minWidth,param2.maxWidth,_loc4_);
         ...
         while(_loc9_ < int(param1.length))
         {
            ...
            if(_loc17_ < _loc10_.height)
            {
               _loc17_ = _loc10_.height;
            }
            _loc10_.x = _loc16_;
            _loc16_ += _loc10_.width + _loc4_;
         }
         var _loc18_:Number = _loc17_;
         _loc16_ += _paddingRight;
         if(int(param1.length) > 0)
         {
            _loc16_ -= _loc4_;
         }
         _loc17_ += _paddingTop + _paddingBottom;
         ...
         applyPercentHeight(param1,_loc20_);
         _loc9_ = 0;
         while(_loc9_ < int(param1.length))
         {
            _loc10_ = param1[_loc9_];
            ...
            {
               case 0:
                  _loc10_.y = _paddingTop;
                  break;
               case 1:
                  _loc10_.y = Math.max(_paddingTop,_paddingTop + (_loc20_ - _paddingTop - _paddingBottom - _loc10_.height) / 2);
                  break;
               case 2:
                  _loc10_.y = Math.max(_paddingTop,_paddingTop + (_loc20_ - _paddingTop - _paddingBottom) - _loc10_.height);
                  break;
               case 3:
                  _loc10_.y = _paddingTop;
                  _loc10_.height = _loc20_ - _paddingTop - _paddingBottom;
                  break;
            }
         }
         var _loc21_:Number = _loc16_ - _paddingLeft - _paddingRight;
         var _loc22_:Number = 0;
         var _loc23_:Number = 0;
         var _loc24_:Number = _loc19_ - _paddingLeft - _paddingRight;
         ...
         else
         {
            switch(_horizontalAlign.index)
            {
               ...
               case 2:
                  ...
                  break;
               default:
                  throw new ArgumentError("Unknown horizontal align: " + String(Std.string(_horizontalAlign)));
            }
            if(_loc22_ < 0)
            {
               _loc22_ = 0;
         ...
         if(!(_loc22_ == 0 && _loc23_ == 0))
         {
            ...
            while(_loc9_ < int(param1.length))
            {
               ...
               _loc10_.x = Math.max(_paddingLeft,_loc10_.x + _loc26_);
               _loc26_ += _loc23_;
            }
         }
         if(_loc16_ < _loc19_)
      ...
      public function applyVerticalAlign(param1:Array, param2:Number, param3:Number) : void
      {
         ...
         while(_loc4_ < int(param1.length))
         {
            ...
            {
               if(!Boolean((_loc6_ = _loc5_).get_includeInLayout()))
               {
                  continue;
               }
            }
            ...
            {
               case 0:
                  _loc5_.y = _paddingTop;
                  break;
               case 1:
                  _loc5_.y = Math.max(_paddingTop,_paddingTop + (param3 - _paddingTop - _paddingBottom - _loc5_.height) / 2);
                  break;
               case 2:
                  _loc5_.y = Math.max(_paddingTop,_paddingTop + (param3 - _paddingTop - _paddingBottom) - _loc5_.height);
                  break;
               case 3:
                  _loc5_.y = _paddingTop;
                  _loc5_.height = param3 - _paddingTop - _paddingBottom;
                  break;
            }
         }
      }
      
      public function applyPercentWidth(param1:Array, param2:Object, param3:Object, param4:Object, param5:Number) : void
      {
         var _loc10_:int = 0;
         var _loc11_:* = null as DisplayObject;
         var _loc12_:* = null as ILayoutObject;
         var _loc13_:* = null as ILayoutData;
         var _loc14_:* = null as HorizontalLayoutData;
         ...
         while(_loc10_ < int(param1.length))
         {
            ...
            {
               if(!Boolean((_loc12_ = _loc11_).get_includeInLayout()))
               {
                  continue;
               }
               if((_loc14_ = (_loc13_ = _loc12_.get_layoutData()) as HorizontalLayoutData) != null)
               {
                  if((_loc15_ = _loc14_.get_percentWidth()) != null)
                  {
                     if(_loc15_ < 0)
                     {
                        _loc15_ = 0;
                     ...
                     {
                        _loc16_ = _loc12_;
                        _loc8_ += Number(_loc16_.get_minWidth());
                     }
                     _loc9_ += _loc15_;
                     _loc7_ += param5;
                     _loc6_.push(_loc12_);
            ...
            _loc7_ += _loc11_.width + param5;
         }
         _loc7_ = (_loc7_ -= param5) + (_paddingLeft + _paddingRight);
         if(_loc9_ < 100)
         {
            _loc9_ = 100;
         }
         ...
         while(_loc18_)
         {
            ...
            while(_loc10_ < int(_loc6_.length))
            {
               ...
               _loc10_++;
               if((_loc15_ = (_loc14_ = _loc12_.get_layoutData()).get_percentWidth()) < 0)
               {
                  _loc15_ = 0;
               }
               ...
               if(_loc12_ is IMeasureObject)
               {
                  _loc21_ = (_loc16_ = _loc12_).get_explicitMinWidth();
      ...
      public function applyPercentHeight(param1:Array, param2:Number) : void
      {
         var _loc5_:* = null as DisplayObject;
         var _loc6_:* = null as ILayoutObject;
         var _loc7_:* = null as ILayoutData;
         var _loc8_:* = null as HorizontalLayoutData;
         var _loc9_:* = null as Object;
         var _loc10_:Number = NaN;
         var _loc11_:* = null as IMeasureObject;
         var _loc12_:* = null as Object;
         var _loc13_:* = null as Object;
         var _loc3_:Number = param2 - _paddingTop - _paddingBottom;
         var _loc4_:int = 0;
         while(_loc4_ < int(param1.length))
         {
            _loc5_ = param1[_loc4_];
            ...
            if(_loc5_ is ILayoutObject)
            {
               if(Boolean((_loc6_ = _loc5_).get_includeInLayout()))
               {
                  if((_loc8_ = (_loc7_ = _loc6_.get_layoutData()) as HorizontalLayoutData) != null)
                  {
                     if((_loc9_ = _loc8_.get_percentHeight()) != null)
                     {
                        if(_loc9_ < 0)
                        {
                           _loc9_ = 0;
                        ...
                        {
                           if((_loc12_ = (_loc11_ = _loc5_).get_explicitMinHeight()) != null)
                           {
                              if(_loc12_ > _loc3_)
                              {
                                 _loc12_ = _loc3_;
                           ...
                           _loc13_ = _loc11_.get_explicitMaxHeight();
      ...
      public function applyHorizontalAlign(param1:Array, param2:Number, param3:Number) : void
      {
         ...
         var _loc4_:Number = 0;
         var _loc5_:Number = 0;
         var _loc6_:Number = param3 - _paddingLeft - _paddingRight;
         ...
         while(_loc10_ < int(param1.length))
         {
            ...
            _loc11_.x = Math.max(_paddingLeft,_loc11_.x + _loc9_);
            _loc9_ += _loc5_;
         }
      }
   }
