package feathers.themes.steel
{
   ...
   public class BaseSteelTheme extends ClassVariantTheme implements IDarkModeTheme
   {
      ...
      {
         var _loc3_:int = param1 >> 16 & 255;
         var _loc4_:int = param1 >> 8 & 255;
         var _loc5_:int = param1 & 255;
         var _loc6_:int = param2 >> 16 & 255;
         var _loc7_:int = param2 >> 8 & 255;
         var _loc8_:int = param2 & 255;
         _loc3_ += _loc6_;
         if(_loc3_ > 255)
         {
            _loc3_ = 255;
