package feathers.layout
{
   ...
   public class HorizontalLayout extends EventDispatcher implements ILayout
   {
      ...
      public function validateItems(param1:Array, param2:Measurements) : void
      {
         ...
         var _loc3_:Boolean = _verticalAlign == VerticalAlign.JUSTIFY;
         ...
         while(_loc6_ < int(param1.length))
         {
            ...
            if(_loc7_ is ILayoutObject)
            {
               ...
               _loc12_ = _loc11_ as HorizontalLayoutData;
               if(_loc12_ != null)
               {
      ...
      public function layout(param1:Array, param2:Measurements, param3:LayoutBoundsResult = undefined) : LayoutBoundsResult
      {
         ...
         var _loc5_:Boolean = _gap == 1 / 0;
         if(_loc5_)
         {
            _loc4_ = _minGap;
         }
         var _loc6_:Boolean = _verticalAlign == VerticalAlign.JUSTIFY;
         ...
         while(_loc9_ < int(param1.length))
         {
            ...
            if(_loc10_ is ILayoutObject)
            {
               ...
               _loc15_ = _loc14_ as HorizontalLayoutData;
               if(_loc15_ != null)
               {
      ...
      public function applyPercentWidth(param1:Array, param2:Object, param3:Object, param4:Object, param5:Number) : void
      {
         ...
         while(_loc10_ < int(param1.length))
         {
            ...
            if(_loc11_ is ILayoutObject)
            {
               ...
               _loc14_ = _loc13_ as HorizontalLayoutData;
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.get_percentWidth();
                  if(_loc15_ != null)
                  {
                     if(_loc15_ < 0)
                     {
         ...
         while(_loc18_)
         {
            ...
            while(_loc10_ < int(_loc6_.length))
            {
               ...
               {
                  _loc16_ = _loc12_;
                  _loc21_ = _loc16_.get_explicitMinWidth();
         ...
         while(_loc4_ < int(param1.length))
         {
            ...
            if(_loc5_ is ILayoutObject)
            {
               ...
               if(_loc6_.get_includeInLayout())
               {
                  ...
                  _loc8_ = _loc7_ as HorizontalLayoutData;
                  if(_loc8_ != null)
                  {
                     _loc9_ = _loc8_.get_percentHeight();
                     if(_loc9_ != null)
                     {
                        if(_loc9_ < 0)
                        {
                        ...
                        {
                           _loc11_ = _loc5_;
                           _loc12_ = _loc11_.get_explicitMinHeight();
                           if(_loc12_ != null)
                           {
                              if(_loc12_ > _loc3_)
                              {
