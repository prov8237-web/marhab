package feathers.controls
{
   ...
   public class Button extends BasicButton implements IFocusObject, IHTMLTextControl, ITextControl
   {
      ...
      {
         var _loc1_:Boolean = get_explicitWidth() == null;
         var _loc2_:Boolean = get_explicitHeight() == null;
         var _loc3_:Boolean = get_explicitMinWidth() == null;
         var _loc4_:Boolean = get_explicitMinHeight() == null;
         var _loc5_:Boolean = get_explicitMaxWidth() == null;
         var _loc6_:Boolean = get_explicitMaxHeight() == null;
         ...
         if(_loc1_)
         {
            ...
            _loc10_ += get_paddingLeft() + get_paddingRight();
            if(_currentBackgroundSkin != null)
            {
         ...
         if(_loc2_)
         {
            ...
            _loc11_ += get_paddingTop() + get_paddingBottom();
            if(_currentBackgroundSkin != null)
            {
