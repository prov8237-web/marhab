package com.distriqt.extension.kotlin
{
   ...
   public final class Kotlin extends EventDispatcher
   {
      ...
      public static const VERSION:String = "1.4.10";
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use Kotlin.service to access the functionality";
      ...
      public function Kotlin()
      {
         ...
         if(_shouldCreateInstance)
         {
            try
            {
               ...
               _extContext = ExtensionContext.createExtensionContext("com.jetbrains.kotlin",null);
         ...
         throw new Error("The singleton has already been created. Use Kotlin.service to access the functionality");
      }
