package com.distriqt.extension.androidx.browser
{
   ...
   public final class Browser extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "androidx.browser";
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use Browser.service to access the functionality";
      ...
      public function Browser()
      {
         ...
         if(_shouldCreateInstance)
         {
            try
            {
               _extensionId = "androidx.browser";
               _extensionIdNumber = -1;
               _extContext = ExtensionContext.createExtensionContext("androidx.browser",null);
         ...
         throw new Error("The singleton has already been created. Use Browser.service to access the functionality");
      }
      ...
      public static function get service() : Browser
      {
         createInstance();
         return _instance;
      }
