package com.distriqt.extension.androidx.appcompat
{
   ...
   public final class AppCompat extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "androidx.appcompat";
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use AppCompat.service to access the functionality";
      
      private static var _instance:AppCompat;
      ...
      public function AppCompat()
      {
         ...
         if(_shouldCreateInstance)
         {
            try
            {
               _extensionId = "androidx.appcompat";
               _extensionIdNumber = -1;
               _extContext = ExtensionContext.createExtensionContext("androidx.appcompat",null);
         ...
         throw new Error("The singleton has already been created. Use AppCompat.service to access the functionality");
      }
      
      public static function get instance() : AppCompat
      {
         createInstance();
         return _instance;
      }
      
      public static function get service() : AppCompat
      {
         createInstance();
         return _instance;
      }
