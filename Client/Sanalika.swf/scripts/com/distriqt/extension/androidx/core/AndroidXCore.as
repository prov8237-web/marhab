package com.distriqt.extension.androidx.core
{
   ...
   public final class AndroidXCore extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "androidx.core";
      ...
      private static var _instance:AndroidXCore;
      ...
      public function AndroidXCore()
      {
         ...
         if(_shouldCreateInstance)
         {
            try
            {
               _extensionId = "androidx.core";
               _extensionIdNumber = -1;
               _extContext = ExtensionContext.createExtensionContext("androidx.core",null);
      ...
      public static function get service() : AndroidXCore
      {
         createInstance();
         return _instance;
      }
