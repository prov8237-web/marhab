package com.distriqt.extension.playservices.identity
{
   ...
   public final class PlayServicesIdentity extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "com.distriqt.playservices.Identity";
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use Identity.service to access the functionality";
      
      private static var _instance:PlayServicesIdentity;
      ...
      public function PlayServicesIdentity()
      {
         super();
         if(_shouldCreateInstance)
         {
            try
            {
               _extContext = ExtensionContext.createExtensionContext("com.distriqt.playservices.Identity",null);
         ...
         throw new Error("The singleton has already been created. Use Identity.service to access the functionality");
      }
      
      public static function get service() : PlayServicesIdentity
      {
         createInstance();
         return _instance;
      }
      ...
      private static function createInstance() : void
      {
         if(_instance == null)
         {
            ...
            _instance = new PlayServicesIdentity();
