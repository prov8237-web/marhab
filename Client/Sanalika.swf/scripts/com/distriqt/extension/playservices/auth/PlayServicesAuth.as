package com.distriqt.extension.playservices.auth
{
   ...
   public final class PlayServicesAuth extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "com.distriqt.playservices.Auth";
      
      public static const VERSION:String = "19.0.0";
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use Auth.service to access the functionality";
      
      private static var _instance:PlayServicesAuth;
      ...
      public function PlayServicesAuth()
      {
         super();
         if(_shouldCreateInstance)
         {
            try
            {
               _extContext = ExtensionContext.createExtensionContext("com.distriqt.playservices.Auth",null);
         ...
         throw new Error("The singleton has already been created. Use Auth.service to access the functionality");
      }
      
      public static function get service() : PlayServicesAuth
      {
         createInstance();
         return _instance;
      }
      ...
      private static function createInstance() : void
      {
         if(_instance == null)
         {
            ...
            _instance = new PlayServicesAuth();
