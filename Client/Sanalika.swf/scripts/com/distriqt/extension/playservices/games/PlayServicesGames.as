package com.distriqt.extension.playservices.games
{
   ...
   public final class PlayServicesGames extends EventDispatcher
   {
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use Games.service to access the functionality";
      ...
      public function PlayServicesGames()
      {
         ...
         if(_shouldCreateInstance)
         {
            try
            {
               _extContext = ExtensionContext.createExtensionContext("com.distriqt.playservices.Games",null);
         ...
         throw new Error("The singleton has already been created. Use Games.service to access the functionality");
      }
