package com.greensock
{
   ...
   public dynamic class TweenProxy extends Proxy
   {
      ...
      {
         var _loc1_:Point = this._target.parent.globalToLocal(this._target.localToGlobal(this._localRegistration));
      ...
      public function set skewX(param1:Number) : void
      {
         var _loc2_:Number = param1 * _DEG2RAD;
         var _loc3_:Matrix = this._target.transform.matrix;
         var _loc4_:Number = this._scaleY < 0 ? -this._scaleY : this._scaleY;
      ...
      public function set skewY(param1:Number) : void
      {
         var _loc2_:Number = param1 * _DEG2RAD;
         var _loc3_:Matrix = this._target.transform.matrix;
         var _loc4_:Number = this._scaleX < 0 ? -this._scaleX : this._scaleX;
