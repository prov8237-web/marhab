package com.greensock
{
   ...
   public class TimelineLite extends SimpleTimeline
   {
      ...
      public function TimelineLite(param1:Object = null)
      {
         ...
         {
            this.insertMultiple(this.vars.tweens,0,this.vars.align != null ? String(this.vars.align) : "normal",Boolean(this.vars.stagger) ? Number(this.vars.stagger) : 0);
         }
      }
