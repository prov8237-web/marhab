   ...
   public class PhysicsPropsPlugin extends TweenPlugin
   {
      ...
      override public function onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         for(_loc5_ in param2)
         {
            ...
            if(Boolean(_loc6_.velocity) || Boolean(_loc6_.acceleration))
            {
               var _loc10_:* = _loc7_++;
               this._props[_loc10_] = new PhysicsProp(_loc5_,Number(param1[_loc5_]),_loc6_.velocity,_loc6_.acceleration,_loc6_.friction,this._stepsPerTimeUnit);
               this.overwriteProps[_loc7_] = _loc5_;
               if(Boolean(_loc6_.friction))
               {
      ...
      override public function set changeFactor(param1:Number) : void
      {
         ...
         else
         {
            while(Boolean(_loc2_--))
            {
               ...
               if(_loc10_ > 0)
               {
                  this._target[PhysicsProp(this._props[_loc2_]).property] = _loc10_ + 0.5 >> 0;
               }
               else
               {
                  this._target[PhysicsProp(this._props[_loc2_]).property] = _loc10_ - 0.5 >> 0;
...
class PhysicsProp
{
   ...
   public function PhysicsProp(param1:String, param2:Number, param3:Number, param4:Number, param5:Number, param6:uint)
   {
      super();
