package com.greensock.motionPaths
{
   ...
   public class LinePath2D extends MotionPath
   {
      ...
      {
         var _loc2_:int = int(this._points.length);
         while(--_loc2_ > -1)
         {
         ...
         while(_loc3_ <= _loc1_)
         {
            if(this._points[_loc3_] != null)
            {
               ...
               else
               {
                  ...
                  this._totalLength += _loc2_.length;
               }
            }
            _loc3_++;
         }
      ...
      override public function update(param1:Event = null) : void
      {
         ...
         while(Boolean(_loc15_))
         {
            ...
            if(_loc5_ != null)
            {
               _loc7_ = (_loc6_ - _loc5_.progress) / (_loc5_.length / this._totalLength);
               ...
               {
                  if(!_loc2_ && (this._prevMatrix.a != _loc9_ || this._prevMatrix.b != _loc10_ || this._prevMatrix.c != _loc11_ || this._prevMatrix.d != _loc12_))
                  {
                     this._updateAngles();
                     _loc2_ = true;
                  }
