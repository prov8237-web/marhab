package com.greensock.motionPaths
{
   ...
   public class CirclePath2D extends MotionPath
   {
      ...
      override public function update(param1:Event = null) : void
      {
         ...
         var _loc5_:Matrix = this.transform.matrix;
         var _loc6_:Number = _loc5_.a;
         ...
         while(Boolean(_loc12_))
         {
            ...
            _loc3_ = Math.cos(_loc2_) * this._radius;
            _loc4_ = Math.sin(_loc2_) * this._radius;
