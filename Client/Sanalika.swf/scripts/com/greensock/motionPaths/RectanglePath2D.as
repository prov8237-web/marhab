package com.greensock.motionPaths
{
   ...
   public class RectanglePath2D extends MotionPath
   {
      ...
      override public function update(param1:Event = null) : void
      {
         ...
         var _loc2_:Number = this._centerOrigin ? this._rawWidth / -2 : 0;
         var _loc3_:Number = this._centerOrigin ? this._rawHeight / -2 : 0;
         var _loc9_:Matrix = this.transform.matrix;
         var _loc10_:Number = _loc9_.a;
         ...
         while(Boolean(_loc16_))
         {
            _loc5_ = _loc2_;
            _loc6_ = _loc3_;
            if(_loc16_.cachedProgress < 0.5)
            {
               _loc4_ = _loc16_.cachedProgress * (this._rawWidth + this._rawHeight) * 2;
               if(_loc4_ > this._rawWidth)
               {
                  _loc5_ += this._rawWidth;
                  _loc6_ += _loc4_ - this._rawWidth;
                  _loc7_ = 0;
                  _loc8_ = this._rawHeight;
               }
               else
               {
                  _loc5_ += _loc4_;
                  _loc7_ = this._rawWidth;
                  _loc8_ = 0;
               }
            }
            else
            {
               _loc4_ = (_loc16_.cachedProgress - 0.5) / 0.5 * (this._rawWidth + this._rawHeight);
               if(_loc4_ <= this._rawWidth)
               {
                  _loc5_ += this._rawWidth - _loc4_;
                  _loc6_ += this._rawHeight;
                  _loc7_ = -this._rawWidth;
                  _loc8_ = 0;
               }
               else
               {
                  _loc6_ += this._rawHeight - (_loc4_ - this._rawWidth);
                  _loc7_ = 0;
                  _loc8_ = -this._rawHeight;
               }
            }
      ...
      override public function renderObjectAt(param1:Object, param2:Number, param3:Boolean = false, param4:Number = 0) : void
      {
         ...
         else
         {
            ...
            {
               _loc6_ += this._rawHeight - (_loc7_ - this._rawWidth);
               _loc8_ = 0;
               _loc9_ = -this._rawHeight;
            }
         }
