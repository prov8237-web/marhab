package com.greensock.layout
{
   ...
   public class AutoFitArea extends Shape
   {
      ...
      public static function createAround(param1:DisplayObject, param2:Object = null, ... rest) : AutoFitArea
      {
         ...
         var _loc7_:AutoFitArea = new AutoFitArea(param1.parent,_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height,_loc5_);
         _loc7_.attach(param1,param2);
         return _loc7_;
      }
      ...
      public function attach(param1:DisplayObject, param2:Object = null, ... rest) : void
      {
         ...
         this.release(param1);
         this._rootItem = new AutoFitItem(param1,param2,this._rootItem);
         if(param2 != null && param2.crop == true)
         {
            _loc4_ = new Shape();
            _loc5_ = this.getBounds(this);
            _loc4_.graphics.beginFill(this._previewColor,1);
            _loc4_.graphics.drawRect(_loc5_.x,_loc5_.y,_loc5_.width,_loc5_.height);
            _loc4_.graphics.endFill();
            _loc4_.visible = false;
            this._parent.addChild(_loc4_);
            this._rootItem.mask = _loc4_;
            param1.mask = _loc4_;
         }
         if(this._preview)
         {
      ...
      public function release(param1:DisplayObject) : Boolean
      {
         ...
         if(Boolean(_loc2_.next))
         {
            _loc2_.next.prev = _loc2_.prev;
         }
         if(Boolean(_loc2_.prev))
         {
      ...
      public function update(param1:Event = null) : void
      {
         ...
         while(Boolean(_loc7_))
         {
            ...
            _loc16_ = _loc7_.scaleMode;
            if(_loc16_ != ScaleMode.NONE)
            {
               ...
               if(_loc7_.calculateVisible)
               {
                  ...
                  _loc14_ = getVisibleBounds(_loc7_.boundsTarget,this._parent);
               }
               else
               {
                  _loc13_ = _loc7_.boundsTarget.getBounds(_loc12_);
                  _loc14_ = _loc7_.boundsTarget.getBounds(this._parent);
               }
               _loc15_ = _loc7_.hasCustomRatio ? _loc7_.aspectRatio : _loc13_.width / _loc13_.height;
               _loc21_ = _loc12_.transform.matrix;
               if(_loc21_.b != 0 || _loc21_.a == 0 || _loc21_.d == 0)
               {
                  ...
                  _loc19_ = Math.sin(_loc18_);
                  if(_loc19_ < 0)
                  {
                     _loc19_ = -_loc19_;
                  }
                  _loc20_ = Math.cos(_loc18_);
                  if(_loc20_ < 0)
                  {
                     _loc20_ = -_loc20_;
                  }
               ...
               {
                  _loc9_ = _loc8_ / _loc15_;
                  if(_loc9_ > _loc7_.maxHeight)
                  {
                     _loc9_ = _loc7_.maxHeight;
                     _loc8_ = _loc9_ * _loc15_;
                  }
            ...
            {
               _loc14_ = _loc7_.calculateVisible ? getVisibleBounds(_loc7_.boundsTarget,this._parent) : _loc7_.boundsTarget.getBounds(this._parent);
            }
            _loc10_ = _loc12_.x;
            _loc11_ = _loc12_.y;
            ...
            else if(_loc7_.hAlign == AlignMode.RIGHT)
            {
            ...
            else if(_loc7_.vAlign == AlignMode.BOTTOM)
            {
      ...
      protected function _redraw(param1:uint) : void
      {
         ...
         _loc2_.clear();
         _loc2_.beginFill(this._previewColor,1);
      ...
      public function set preview(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            while(Boolean(_loc4_))
            {
               ...
               {
                  _loc3_ = uint(this._parent.getChildIndex(_loc4_.target));
                  if(_loc3_ < _loc2_)
                  {
                     _loc2_ = _loc3_;
                  }
