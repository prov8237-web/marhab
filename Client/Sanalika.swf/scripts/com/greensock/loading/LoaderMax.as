   ...
   public class LoaderMax extends LoaderCore
   {
      ...
      public static function parse(param1:*, param2:Object = null, param3:Object = null) : *
      {
         ...
         if(param1 is String || param1 is URLRequest)
         {
            ...
            _loc7_ = String(_loc7_.toLowerCase().split("?")[0]);
      ...
      {
         var _loc3_:int = int(this._loaders.length);
         while(--_loc3_ > -1)
         {
            if(param1)
            {
      ...
      override protected function _dump(param1:int = 0, param2:int = 0, param3:Boolean = false) : void
      {
         ...
         if(param1 == 1)
         {
            _loc4_ = int(this._loaders.length);
            while(--_loc4_ > -1)
            {
      ...
      override protected function _calculateProgress() : void
      {
         ...
         _cachedBytesTotal = 0;
         var _loc1_:int = int(this._loaders.length);
         while(--_loc1_ > -1)
         {
      ...
      {
         var _loc3_:Array = [];
         var _loc4_:int = int(this._loaders.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            ...
            if(param1 && Boolean(this._loaders[_loc5_].hasOwnProperty("getChildren")))
            {
      ...
      override public function get status() : int
      {
         ...
         {
            _loc1_ = [0,0,0,0,0,0];
            _loc2_ = int(this._loaders.length);
            while(--_loc2_ > -1)
            {
      ...
      public function get rawProgress() : Number
      {
         ...
         while(--_loc4_ > -1)
         {
            ...
            {
               _loc2_++;
               _loc1_ += this._loaders[_loc4_] is LoaderMax ? LoaderMax(this._loaders[_loc4_]).rawProgress : LoaderCore(this._loaders[_loc4_]).progress;
            }
         }
