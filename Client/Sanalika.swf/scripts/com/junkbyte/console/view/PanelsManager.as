package com.junkbyte.console.view
{
   ...
   public class PanelsManager
   {
      ...
      {
         return Boolean(this.console.getChildByName(param1) as ConsolePanel) ? true : false;
      }
      ...
      public function setPanelArea(param1:String, param2:Rectangle) : void
      {
         ...
         if(Boolean(_loc3_))
         {
            _loc3_.x = param2.x;
            _loc3_.y = param2.y;
            if(Boolean(param2.width))
            {
               _loc3_.width = param2.width;
            }
            if(Boolean(param2.height))
            {
      ...
      {
         return Boolean(this.getPanel(RollerPanel.NAME) as RollerPanel) ? true : false;
      }
      ...
      private function onPanelStartDragScale(param1:Event) : void
      {
         ...
         if(Boolean(this.console.config.style.panelSnapping))
         {
            _loc3_ = [0];
            _loc4_ = [0];
            if(Boolean(this.console.stage))
            {
