package haxe.ds
{
   ...
   public class BalancedTree implements IMap
   {
      ...
      public function setLoop(param1:Object, param2:Object, param3:TreeNode) : TreeNode
      {
         ...
         var _loc4_:int = compare(param1,param3.key);
         if(_loc4_ == 0)
         {
      ...
      public function removeMinBinding(param1:TreeNode) : TreeNode
      {
         if(param1.left == null)
         {
            return param1.right;
         }
         return balance(removeMinBinding(param1.left),param1.key,param1.value,param1.right);
      }
      
      public function removeLoop(param1:Object, param2:TreeNode) : TreeNode
      {
         if(param2 == null)
         {
            throw Exception.thrown("Not_found");
         }
         var _loc3_:int = compare(param1,param2.key);
         if(_loc3_ == 0)
         {
            return merge(param2.left,param2.right);
         }
         if(_loc3_ < 0)
         {
            return balance(removeLoop(param1,param2.left),param2.key,param2.value,param2.right);
         }
         return balance(param2.left,param2.key,param2.value,removeLoop(param1,param2.right));
      }
      ...
      public function minBinding(param1:TreeNode) : TreeNode
      {
         if(param1 == null)
         {
            throw Exception.thrown("Not_found");
         ...
         return minBinding(param1.left);
      }
      
      public function merge(param1:TreeNode, param2:TreeNode) : TreeNode
      {
         if(param1 == null)
         {
            return param2;
         ...
         var _loc3_:TreeNode = minBinding(param2);
         return balance(param1,_loc3_.key,_loc3_.value,removeMinBinding(param2));
      }
      ...
      public function get(param1:Object) : Object
      {
         ...
         while(_loc2_ != null)
         {
            _loc3_ = compare(param1,_loc2_.key);
            if(_loc3_ == 0)
            {
               return _loc2_.value;
            }
