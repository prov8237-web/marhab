package lime.app
{
   public class Promise_String
   {
      ...
      public function Promise_String()
      {
         future = new Future();
      }
      
      public function progress(param1:int, param2:int) : Promise_String
      {
         var _loc3_:int = 0;
      ...
      public function error(param1:*) : Promise_String
      {
         var _loc2_:int = 0;
      ...
      public function completeWith(param1:Future) : Promise_String
      {
      ...
      public function complete(param1:String) : Promise_String
      {
         var _loc2_:int = 0;
         var _loc3_:* = null as Array;
         var _loc4_:* = null as Function;
