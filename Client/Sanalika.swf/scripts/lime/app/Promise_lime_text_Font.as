package lime.app
{
   ...
   public class Promise_lime_text_Font
   {
      ...
      public function Promise_lime_text_Font()
      {
         future = new Future();
      }
      
      public function progress(param1:int, param2:int) : Promise_lime_text_Font
      {
         var _loc3_:int = 0;
      ...
      public function error(param1:*) : Promise_lime_text_Font
      {
         var _loc2_:int = 0;
      ...
      public function completeWith(param1:Future) : Promise_lime_text_Font
      {
      ...
      public function complete(param1:Font) : Promise_lime_text_Font
      {
         var _loc2_:int = 0;
         var _loc3_:* = null as Array;
         var _loc4_:* = null as Function;
