package lime.app
{
   ...
   public class Promise_haxe_io_Bytes
   {
      ...
      public function Promise_haxe_io_Bytes()
      {
         future = new Future();
      }
      
      public function progress(param1:int, param2:int) : Promise_haxe_io_Bytes
      {
         var _loc3_:int = 0;
      ...
      public function error(param1:*) : Promise_haxe_io_Bytes
      {
         var _loc2_:int = 0;
      ...
      public function completeWith(param1:Future) : Promise_haxe_io_Bytes
      {
      ...
      public function complete(param1:Bytes) : Promise_haxe_io_Bytes
      {
         var _loc2_:int = 0;
         var _loc3_:* = null as Array;
         var _loc4_:* = null as Function;
