package lime.app
{
   ...
   public class Promise_openfl_display_MovieClip
   {
      ...
      public function Promise_openfl_display_MovieClip()
      {
         future = new Future();
      }
      
      public function progress(param1:int, param2:int) : Promise_openfl_display_MovieClip
      {
         var _loc3_:int = 0;
      ...
      public function error(param1:*) : Promise_openfl_display_MovieClip
      {
         var _loc2_:int = 0;
      ...
      public function completeWith(param1:Future) : Promise_openfl_display_MovieClip
      {
      ...
      public function complete(param1:MovieClip) : Promise_openfl_display_MovieClip
      {
         var _loc2_:int = 0;
         var _loc3_:* = null as Array;
         var _loc4_:* = null as Function;
