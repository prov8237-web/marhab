package lime._internal.graphics
{
   ...
   public class ImageDataUtil
   {
      ...
      public static function displaceMap(param1:Image, param2:Image, param3:Image, param4:Vector2, param5:Vector4, param6:Vector4, param7:Boolean) : void
      {
         ...
         while(_loc37_ < _loc38_)
         {
            ...
            while(_loc40_ < _loc41_)
            {
               ...
               _loc31_ = int(param4.x);
               _loc32_ = int(param4.y);
               if(param7)
               {
               ...
               _loc33_ = int(Math.floor(_loc35_ * _loc17_.width));
               _loc34_ = int(Math.floor(_loc36_ * _loc17_.height));
               if(param7)
               {
      ...
      {
         var _loc4_:int = 0;
         var _loc5_:int = int(Math.floor(ImageDataUtil.lerp(param1 >> 24 & 255,param2 >> 24 & 255,param3)));
         _loc4_ = (_loc5_ & 255) << 24 | (_loc4_ >> 16 & 255 & 255) << 16 | (_loc4_ >> 8 & 255 & 255) << 8 | _loc4_ & 255 & 255;
         _loc5_ = int(Math.floor(ImageDataUtil.lerp(param1 >> 16 & 255,param2 >> 16 & 255,param3)));
         _loc4_ = (_loc4_ >> 24 & 255 & 255) << 24 | (_loc5_ & 255) << 16 | (_loc4_ >> 8 & 255 & 255) << 8 | _loc4_ & 255 & 255;
         _loc5_ = int(Math.floor(ImageDataUtil.lerp(param1 >> 8 & 255,param2 >> 8 & 255,param3)));
         _loc4_ = (_loc4_ >> 24 & 255 & 255) << 24 | (_loc4_ >> 16 & 255 & 255) << 16 | (_loc5_ & 255) << 8 | _loc4_ & 255 & 255;
         _loc5_ = int(Math.floor(ImageDataUtil.lerp(param1 & 255,param2 & 255,param3)));
      ...
      public static function copyPixels(param1:Image, param2:Image, param3:Rectangle, param4:Vector2, param5:Image = undefined, param6:Vector2 = undefined, param7:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc26_ = int(param2.buffer.bitsPerPixel / 8);
            _loc27_ = int(param1.buffer.bitsPerPixel / 8);
               ...
               if(_loc29_)
               {
                  ...
                  while(_loc30_ < _loc31_)
                  {
                     ...
                     while(_loc33_ < _loc34_)
                     {
                        ...
                        {
                           _loc36_ = RGBA_Impl_.__clamp;
                           _loc39_ = int(int(_loc36_.buffer.b[_loc36_.byteOffset + int(Math.round(((_loc22_ >> 24 & 255) * _loc18_ + (_loc23_ >> 24 & 255) * _loc19_ * _loc20_) / _loc21_))]));
                           _loc23_ = (_loc39_ & 255) << 24 | (_loc23_ >> 16 & 255 & 255) << 16 | (_loc23_ >> 8 & 255 & 255) << 8 | _loc23_ & 255 & 255;
                           _loc36_ = RGBA_Impl_.__clamp;
                           _loc39_ = int(int(_loc36_.buffer.b[_loc36_.byteOffset + int(Math.round(((_loc22_ >> 16 & 255) * _loc18_ + (_loc23_ >> 16 & 255) * _loc19_ * _loc20_) / _loc21_))]));
                           _loc23_ = (_loc23_ >> 24 & 255 & 255) << 24 | (_loc39_ & 255) << 16 | (_loc23_ >> 8 & 255 & 255) << 8 | _loc23_ & 255 & 255;
                           _loc36_ = RGBA_Impl_.__clamp;
                           _loc39_ = int(int(_loc36_.buffer.b[_loc36_.byteOffset + int(Math.round(((_loc22_ >> 8 & 255) * _loc18_ + (_loc23_ >> 8 & 255) * _loc19_ * _loc20_) / _loc21_))]));
               ...
               if(_loc29_)
               {
                  ...
                  while(_loc33_ < _loc34_)
                  {
                     ...
                     for(; _loc39_ < _loc43_; _loc16_ += 4,_loc17_ += 4,_loc31_ += 4)
                     {
                        ...
                        _loc18_ = (_loc32_ & 255) / 255 * ((_loc22_ & 255) / 255);
                        if(_loc18_ <= 0)
                        {
                           continue;
                        }
                        ...
                        _loc21_ = _loc18_ + _loc19_ * _loc20_;
                        _loc37_ = RGBA_Impl_.__clamp;
                        _loc46_ = int(int(_loc37_.buffer.b[_loc37_.byteOffset + int(Math.round(((_loc22_ >> 24 & 255) * _loc18_ + (_loc23_ >> 24 & 255) * _loc19_ * _loc20_) / _loc21_))]));
                        _loc23_ = (_loc46_ & 255) << 24 | (_loc23_ >> 16 & 255 & 255) << 16 | (_loc23_ >> 8 & 255 & 255) << 8 | _loc23_ & 255 & 255;
                        _loc37_ = RGBA_Impl_.__clamp;
                        _loc46_ = int(int(_loc37_.buffer.b[_loc37_.byteOffset + int(Math.round(((_loc22_ >> 16 & 255) * _loc18_ + (_loc23_ >> 16 & 255) * _loc19_ * _loc20_) / _loc21_))]));
                        _loc23_ = (_loc23_ >> 24 & 255 & 255) << 24 | (_loc46_ & 255) << 16 | (_loc23_ >> 8 & 255 & 255) << 8 | _loc23_ & 255 & 255;
                        _loc37_ = RGBA_Impl_.__clamp;
                        _loc46_ = int(int(_loc37_.buffer.b[_loc37_.byteOffset + int(Math.round(((_loc22_ >> 8 & 255) * _loc18_ + (_loc23_ >> 8 & 255) * _loc19_ * _loc20_) / _loc21_))]));
               ...
               else
               {
                  ...
                  while(_loc33_ < _loc34_)
                  {
                     ...
                     while(_loc39_ < _loc43_)
                     {
                        ...
                        _loc46_ = int(Math.round((_loc22_ & 255) * ((_loc32_ & 255) / 255)));
      ...
      public static function fillRect(param1:Image, param2:Rectangle, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            case 1:
               ...
               _loc7_ = 0;
               _loc8_ = _loc7_;
               _loc8_ = (_loc6_ >> 16 & 255 & 255) << 24 | (_loc6_ >> 8 & 255 & 255) << 16 | (_loc6_ & 255 & 255) << 8 | _loc6_ >> 24 & 255 & 255;
               _loc5_ = _loc8_;
               break;
            case 2:
               _loc6_ = param3;
               _loc7_ = 0;
               _loc8_ = _loc7_;
               _loc8_ = (_loc6_ >> 8 & 255 & 255) << 24 | (_loc6_ >> 16 & 255 & 255) << 16 | (_loc6_ >> 24 & 255 & 255) << 8 | _loc6_ & 255 & 255;
               _loc5_ = _loc8_;
               break;
            default:
               _loc5_ = param3;
      ...
      public static function floodFill(param1:Image, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         var _loc19_:int = _loc11_ + param1.width;
         var _loc20_:int = _loc18_ + param1.height;
         var _loc21_:Array = [];
         _loc21_.push(param2);
         _loc21_.push(param3);
         var _loc27_:int = 0;
         while(int(_loc21_.length) > 0)
         {
            ...
            {
               _loc29_ = _loc28_++;
               _loc24_ = int(_loc22_ + int(_loc16_[_loc29_]));
               _loc25_ = int(_loc23_ + int(_loc17_[_loc29_]));
      ...
      public static function getColorBoundsRect(param1:Image, param2:int, param3:int, param4:Boolean, param5:int) : Rectangle
      {
         ...
         var _loc20_:int = 0;
         var _loc21_:int = 0;
         var _loc6_:int = param1.width + 1;
         var _loc7_:int = 0;
         var _loc8_:int = param1.height + 1;
         var _loc9_:int = 0;
         switch(param5)
         {
            case 1:
               ...
               _loc13_ = 0;
               _loc14_ = _loc13_;
               _loc14_ = (_loc12_ >> 16 & 255 & 255) << 24 | (_loc12_ >> 8 & 255 & 255) << 16 | (_loc12_ & 255 & 255) << 8 | _loc12_ >> 24 & 255 & 255;
               _loc10_ = _loc14_;
               _loc15_ = param2;
               _loc16_ = 0;
               _loc17_ = _loc16_;
               _loc17_ = (_loc15_ >> 16 & 255 & 255) << 24 | (_loc15_ >> 8 & 255 & 255) << 16 | (_loc15_ & 255 & 255) << 8 | _loc15_ >> 24 & 255 & 255;
               _loc11_ = _loc17_;
               break;
            case 2:
               _loc12_ = param3;
               _loc13_ = 0;
               _loc14_ = _loc13_;
               _loc14_ = (_loc12_ >> 8 & 255 & 255) << 24 | (_loc12_ >> 16 & 255 & 255) << 16 | (_loc12_ >> 24 & 255 & 255) << 8 | _loc12_ & 255 & 255;
               _loc10_ = _loc14_;
               _loc15_ = param2;
               _loc16_ = 0;
               _loc17_ = _loc16_;
               _loc17_ = (_loc15_ >> 8 & 255 & 255) << 24 | (_loc15_ >> 16 & 255 & 255) << 16 | (_loc15_ >> 24 & 255 & 255) << 8 | _loc15_ & 255 & 255;
               _loc11_ = _loc17_;
               break;
            default:
               _loc10_ = param3;
      ...
      public static function getPixels(param1:Image, param2:Rectangle, param3:int) : Bytes
      {
         ...
         var _loc4_:int = int(param2.width * param2.height);
            ...
            while(_loc18_ < _loc19_)
            {
               ...
               switch(param3)
               {
                  case 1:
                     _loc24_ = 0;
                     _loc25_ = _loc24_;
                     _loc25_ = (_loc13_ & 255 & 255) << 24 | (_loc13_ >> 24 & 255 & 255) << 16 | (_loc13_ >> 16 & 255 & 255) << 8 | _loc13_ >> 8 & 255 & 255;
                     _loc11_ = _loc25_;
                     _loc13_ = _loc11_;
                     break;
                  case 2:
                     _loc24_ = 0;
                     _loc25_ = _loc24_;
                     _loc25_ = (_loc13_ >> 8 & 255 & 255) << 24 | (_loc13_ >> 16 & 255 & 255) << 16 | (_loc13_ >> 24 & 255 & 255) << 8 | _loc13_ & 255 & 255;
                     _loc12_ = _loc25_;
                     _loc13_ = _loc12_;
                     break;
               }
      ...
      public static function merge(param1:Image, param2:Image, param3:Rectangle, param4:Vector2, param5:int, param6:int, param7:int, param8:int) : void
      {
         ...
         while(_loc21_ < _loc22_)
         {
            ...
            while(_loc24_ < _loc25_)
            {
               ...
               _loc30_ = int(((_loc19_ >> 24 & 255) * param5 + (_loc20_ >> 24 & 255) * (256 - param5)) / 256);
               _loc20_ = (_loc30_ & 255) << 24 | (_loc20_ >> 16 & 255 & 255) << 16 | (_loc20_ >> 8 & 255 & 255) << 8 | _loc20_ & 255 & 255;
               _loc30_ = int(((_loc19_ >> 16 & 255) * param6 + (_loc20_ >> 16 & 255) * (256 - param6)) / 256);
               _loc20_ = (_loc20_ >> 24 & 255 & 255) << 24 | (_loc30_ & 255) << 16 | (_loc20_ >> 8 & 255 & 255) << 8 | _loc20_ & 255 & 255;
               _loc30_ = int(((_loc19_ >> 8 & 255) * param7 + (_loc20_ >> 8 & 255) * (256 - param7)) / 256);
               _loc20_ = (_loc20_ >> 24 & 255 & 255) << 24 | (_loc20_ >> 16 & 255 & 255) << 16 | (_loc30_ & 255) << 8 | _loc20_ & 255 & 255;
               _loc30_ = int(((_loc19_ & 255) * param8 + (_loc20_ & 255) * (256 - param8)) / 256);
      ...
      public static function multiplyAlpha(param1:Image) : void
      {
         ...
         var _loc4_:int = int(_loc2_.length / 4);
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      public static function setFormat(param1:Image, param2:int) : void
      {
         ...
         var _loc6_:int = int(_loc3_.length / 4);
      ...
      public static function setPixel(param1:Image, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         switch(param5)
         {
            case 1:
               ...
               _loc8_ = 0;
               _loc9_ = _loc8_;
               _loc9_ = (_loc7_ >> 16 & 255 & 255) << 24 | (_loc7_ >> 8 & 255 & 255) << 16 | (_loc7_ & 255 & 255) << 8 | _loc7_ >> 24 & 255 & 255;
               _loc6_ = _loc9_;
               break;
            case 2:
               _loc7_ = param4;
               _loc8_ = 0;
               _loc9_ = _loc8_;
               _loc9_ = (_loc7_ >> 8 & 255 & 255) << 24 | (_loc7_ >> 16 & 255 & 255) << 16 | (_loc7_ >> 24 & 255 & 255) << 8 | _loc7_ & 255 & 255;
               _loc6_ = _loc9_;
               break;
            default:
               _loc6_ = param4;
      ...
      public static function setPixels(param1:Image, param2:Rectangle, param3:BytePointerData, param4:int, param5:Endian) : void
      {
         ...
         var _loc16_:Boolean = param5 != Endian.BIG_ENDIAN;
         var _loc17_:int = 0;
            ...
            while(_loc20_ < _loc21_)
            {
               ...
               switch(param4)
               {
                  case 1:
                     ...
                     _loc24_ = 0;
                     _loc25_ = _loc24_;
                     _loc25_ = (_loc23_ >> 16 & 255 & 255) << 24 | (_loc23_ >> 8 & 255 & 255) << 16 | (_loc23_ & 255 & 255) << 8 | _loc23_ >> 24 & 255 & 255;
                     _loc12_ = _loc25_;
                     break;
                  case 2:
                     _loc23_ = _loc11_;
                     _loc24_ = 0;
                     _loc25_ = _loc24_;
                     _loc25_ = (_loc23_ >> 8 & 255 & 255) << 24 | (_loc23_ >> 16 & 255 & 255) << 16 | (_loc23_ >> 24 & 255 & 255) << 8 | _loc23_ & 255 & 255;
                     _loc12_ = _loc25_;
                     break;
                  default:
                     _loc12_ = _loc11_;
      ...
      public static function threshold(param1:Image, param2:Image, param3:Rectangle, param4:Vector2, param5:String, param6:int, param7:int, param8:int, param9:Boolean, param10:int) : int
      {
         ...
         switch(param10)
         {
            case 1:
               ...
               _loc15_ = 0;
               _loc16_ = _loc15_;
               _loc16_ = (_loc14_ >> 16 & 255 & 255) << 24 | (_loc14_ >> 8 & 255 & 255) << 16 | (_loc14_ & 255 & 255) << 8 | _loc14_ >> 24 & 255 & 255;
               _loc11_ = _loc16_;
               _loc17_ = param8;
               _loc18_ = 0;
               _loc19_ = _loc18_;
               _loc19_ = (_loc17_ >> 16 & 255 & 255) << 24 | (_loc17_ >> 8 & 255 & 255) << 16 | (_loc17_ & 255 & 255) << 8 | _loc17_ >> 24 & 255 & 255;
               _loc12_ = _loc19_;
               _loc20_ = param6;
               _loc21_ = 0;
               _loc22_ = _loc21_;
               _loc22_ = (_loc20_ >> 16 & 255 & 255) << 24 | (_loc20_ >> 8 & 255 & 255) << 16 | (_loc20_ & 255 & 255) << 8 | _loc20_ >> 24 & 255 & 255;
               _loc13_ = _loc22_;
               break;
            case 2:
               _loc14_ = param7;
               _loc15_ = 0;
               _loc16_ = _loc15_;
               _loc16_ = (_loc14_ >> 8 & 255 & 255) << 24 | (_loc14_ >> 16 & 255 & 255) << 16 | (_loc14_ >> 24 & 255 & 255) << 8 | _loc14_ & 255 & 255;
               _loc11_ = _loc16_;
               _loc17_ = param8;
               _loc18_ = 0;
               _loc19_ = _loc18_;
               _loc19_ = (_loc17_ >> 8 & 255 & 255) << 24 | (_loc17_ >> 16 & 255 & 255) << 16 | (_loc17_ >> 24 & 255 & 255) << 8 | _loc17_ & 255 & 255;
               _loc12_ = _loc19_;
               _loc20_ = param6;
               _loc21_ = 0;
               _loc22_ = _loc21_;
               _loc22_ = (_loc20_ >> 8 & 255 & 255) << 24 | (_loc20_ >> 16 & 255 & 255) << 16 | (_loc20_ >> 24 & 255 & 255) << 8 | _loc20_ & 255 & 255;
               _loc13_ = _loc22_;
               break;
            default:
               _loc11_ = param7;
         ...
         while(_loc32_ < _loc33_)
         {
            ...
            for(; _loc35_ < _loc36_; _loc18_ += 4,_loc19_ += 4)
            {
               ...
               _loc41_ = uint(uint(_loc30_ >>> 24) & 255);
      ...
      public static function __boxBlurT(param1:ArrayBufferView, param2:ArrayBufferView, param3:int, param4:int, param5:int, param6:int) : void
      {
         ...
         var _loc21_:uint = 0;
         var _loc7_:Number = 1 / (param5 + param5 + 1);
         var _loc8_:int = param3 * 4;
         var _loc15_:int = 0;
         var _loc16_:int = param3;
         while(_loc15_ < _loc16_)
         {
            _loc17_ = _loc15_++;
            _loc9_ = _loc17_ * 4 + param6;
            _loc10_ = _loc9_;
      ...
      {
         var _loc5_:int = param3 - int(param2.x);
         var _loc6_:int = param4 - int(param2.y);
         var _loc7_:int = 0;
      ...
      public static function __getBoxesForGaussianBlur(param1:Number, param2:int) : Array
      {
         ...
         var _loc4_:int = int(Math.floor(_loc3_));
         if(int(_loc4_ % 2) == 0)
         {
            _loc4_--;
         }
         ...
         var _loc7_:int = int(Math.round(_loc6_));
         var _loc8_:Array = [];
         var _loc9_:int = 0;
      ...
      public static function __translatePixel(param1:ArrayBufferView, param2:Rectangle, param3:Rectangle, param4:Vector2, param5:int, param6:int, param7:Number) : void
      {
         ...
         var _loc12_:uint = 0;
         var _loc13_:int = 0;
         var _loc8_:int = 4 * (param6 * int(param3.width) + param5);
         ...
         else
         {
            ...
            param1.buffer.b[param1.byteOffset + (_loc8_ + 2)] = _loc10_;
            _loc13_ = int(int(param1.buffer.b[param1.byteOffset + (_loc9_ + 3)]) * param7);
