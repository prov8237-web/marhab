package lime.math._BGRA
{
   import haxe.io.Bytes;
   import lime.math._RGBA.RGBA_Impl_;
   import lime.utils.ArrayBufferView;
   
   public final class BGRA_Impl_
   {
      ...
      public static function multiplyAlpha(param1:int) : void
      {
         ...
         else if((param1 & 255) != 255)
         {
            ...
            BGRA_Impl_.a16 = int(_loc3_.b[_loc4_]) | int(_loc3_.b[_loc4_ + 1]) << 8 | int(_loc3_.b[_loc4_ + 2]) << 16 | int(_loc3_.b[_loc4_ + 3]) << 24;
            param1 = ((param1 >> 24 & 255) * BGRA_Impl_.a16 >> 16 & 255) << 24 | ((param1 >> 16 & 255) * BGRA_Impl_.a16 >> 16 & 255) << 16 | ((param1 >> 8 & 255) * BGRA_Impl_.a16 >> 16 & 255) << 8 | param1 & 255 & 255;
         }
      }
      ...
      public static function readUInt8(param1:int, param2:ArrayBufferView, param3:int, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         switch(param4)
         {
            case 0:
               ...
               break;
            case 1:
               param1 = (int(int(param2.buffer.b[param2.byteOffset + (param3 + 3)])) & 255) << 24 | (int(int(param2.buffer.b[param2.byteOffset + (param3 + 2)])) & 255) << 16 | (int(int(param2.buffer.b[param2.byteOffset + (param3 + 1)])) & 255) << 8 | int(int(param2.buffer.b[param2.byteOffset + param3])) & 255;
               break;
            case 2:
         ...
         if(param5)
         {
            ...
            {
               BGRA_Impl_.unmult = 255 / (param1 & 255);
               _loc6_ = RGBA_Impl_.__clamp;
               _loc7_ = RGBA_Impl_.__clamp;
               _loc8_ = RGBA_Impl_.__clamp;
               param1 = (int(int(_loc6_.buffer.b[_loc6_.byteOffset + int(Math.floor((param1 >> 24 & 255) * BGRA_Impl_.unmult))])) & 255) << 24 | (int(int(_loc7_.buffer.b[_loc7_.byteOffset + int(Math.floor((param1 >> 16 & 255) * BGRA_Impl_.unmult))])) & 255) << 16 | (int(int(_loc8_.buffer.b[_loc8_.byteOffset + int(Math.floor((param1 >> 8 & 255) * BGRA_Impl_.unmult))])) & 255) << 8 | param1 & 255 & 255;
            }
         }
      }
      ...
      public static function unmultiplyAlpha(param1:int) : void
      {
         ...
         if((param1 & 255) != 0 && (param1 & 255) != 255)
         {
            ...
            param1 = (int(int(_loc2_.buffer.b[_loc2_.byteOffset + int(Math.floor((param1 >> 24 & 255) * BGRA_Impl_.unmult))])) & 255) << 24 | (int(int(_loc3_.buffer.b[_loc3_.byteOffset + int(Math.floor((param1 >> 16 & 255) * BGRA_Impl_.unmult))])) & 255) << 16 | (int(int(_loc4_.buffer.b[_loc4_.byteOffset + int(Math.floor((param1 >> 8 & 255) * BGRA_Impl_.unmult))])) & 255) << 8 | param1 & 255 & 255;
         }
      }
      ...
      public static function writeUInt8(param1:int, param2:ArrayBufferView, param3:int, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         if(param5)
         {
            ...
            else if((param1 & 255) != 255)
            {
               ...
               BGRA_Impl_.a16 = int(_loc7_.b[_loc8_]) | int(_loc7_.b[_loc8_ + 1]) << 8 | int(_loc7_.b[_loc8_ + 2]) << 16 | int(_loc7_.b[_loc8_ + 3]) << 24;
               param1 = ((param1 >> 24 & 255) * BGRA_Impl_.a16 >> 16 & 255) << 24 | ((param1 >> 16 & 255) * BGRA_Impl_.a16 >> 16 & 255) << 16 | ((param1 >> 8 & 255) * BGRA_Impl_.a16 >> 16 & 255) << 8 | param1 & 255 & 255;
            }
         }
         switch(param4)
