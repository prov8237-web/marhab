   ...
   public class Preloader extends Sprite
   {
      ...
      public function updateProgress() : void
      {
         ...
         if(loadedStage && loadedLibraries == int(libraries.length) && !initLibraryNames)
         {
            ...
            {
               name1 = [String(_loc2_[_loc1_])];
               _loc1_++;
               Log.verbose("Preloading asset library: " + String(name1[0]),{
                  "fileName":"lime/utils/Preloader.hx",
                  "lineNumber":236,
                  "className":"lime.utils.Preloader",
                  "methodName":"updateProgress"
               });
               Assets.loadLibrary(String(name1[0])).onProgress((function(param1:Array):Function
               {
                  ...
                  return function(param1:int, param2:int):void
                  {
                     ...
                     if(param2 > 0)
                     {
                        ...
                        if(!(String(name1[0]) in StringMap.reserved ? _loc3_.existsReserved(String(name1[0])) : String(name1[0]) in _loc3_.h))
                        {
                           _loc4_ = _gthis.bytesTotalCache;
                           if(String(name1[0]) in StringMap.reserved)
                           {
                              _loc4_.setReserved(String(name1[0]),param2);
                           }
                           else
                           {
                              _loc4_.h[String(name1[0])] = param2;
                           }
                        ...
                        if(!(String(name1[0]) in StringMap.reserved ? _loc4_.existsReserved(String(name1[0])) : String(name1[0]) in _loc4_.h))
                        {
                        ...
                        else
                        {
                           ...
                           _gthis.bytesLoaded += param1 - (String(name1[0]) in StringMap.reserved ? _loc5_.getReserved(String(name1[0])) : _loc5_.h[String(name1[0])]);
                        }
                        _loc5_ = _gthis.bytesLoadedCache2;
                        if(String(name1[0]) in StringMap.reserved)
                        {
                           _loc5_.setReserved(String(name1[0]),param1);
                        }
                        else
                        {
                           _loc5_.h[String(name1[0])] = param1;
                        }
               ...
               })(name1)).onComplete((function(param1:Array):Function
               {
                  ...
                  return function(param1:AssetLibrary):void
                  {
                     ...
                     {
                        _loc4_ = _gthis.bytesTotalCache;
                        _loc2_ = int(String(name1[0]) in StringMap.reserved ? _loc4_.getReserved(String(name1[0])) : _loc4_.h[String(name1[0])]);
                     }
                     _loc4_ = _gthis.bytesLoadedCache2;
                     if(!(String(name1[0]) in StringMap.reserved ? _loc4_.existsReserved(String(name1[0])) : String(name1[0]) in _loc4_.h))
                     {
                     ...
                     {
                        _loc5_ = _gthis.bytesLoadedCache2;
                        _gthis.bytesLoaded += _loc2_ - (String(name1[0]) in StringMap.reserved ? _loc5_.getReserved(String(name1[0])) : _loc5_.h[String(name1[0])]);
                     }
                     _gthis.loadedAssetLibrary(String(name1[0]));
                  };
         ...
         while(_loc1_ < int(_loc2_.length))
         {
            ...
            })(library)).onComplete((function(param1:Array):Function
            {
               ...
               return function(param1:AssetLibrary):void
               {
                  ...
                  {
                     _gthis.bytesLoaded += library[0].bytesTotal - _gthis.bytesLoadedCache[library[0]];
                  }
