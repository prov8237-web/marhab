package lime.utils._Int8Array
{
   ...
   public final class Int8Array_Impl_
   {
      
      public static var BYTES_PER_ELEMENT:int;
       
      
      public function Int8Array_Impl_()
      {
      }
      ...
      public static function _new(param1:Object = undefined, param2:Bytes = undefined, param3:Array = undefined, param4:Vector.<int> = undefined, param5:ArrayBufferView = undefined, param6:Object = undefined, param7:Object = undefined) : ArrayBufferView
      {
         ...
         if(param1 != null)
         {
            _loc8_ = new ArrayBufferView(param1,1);
         }
         else if(param3 != null)
         {
            _loc9_ = new ArrayBufferView(0,1);
            _loc9_.byteOffset = 0;
      ...
      public static function fromBytes(param1:Bytes, param2:Object = undefined, param3:Object = undefined) : ArrayBufferView
      {
         ...
         if(param2 == null)
         {
            ...
            if(_loc4_ != null)
            {
               _loc10_ = new ArrayBufferView(_loc4_,1);
            }
            else if(_loc6_ != null)
            {
               _loc11_ = new ArrayBufferView(0,1);
               _loc11_.byteOffset = 0;
               _loc11_.length = int(_loc6_.length);
               _loc11_.byteLength = _loc11_.length * _loc11_.bytesPerElement;
               _loc12_ = Bytes.alloc(_loc11_.byteLength);
               _loc11_.buffer = _loc12_;
               _loc11_.copyFromArray(_loc6_);
               _loc10_ = _loc11_;
            }
            else if(_loc7_ != null)
            {
               _loc11_ = new ArrayBufferView(0,1);
               _loc13_ = _loc7_.__array;
               _loc11_.byteOffset = 0;
               _loc11_.length = int(_loc13_.length);
               _loc11_.byteLength = _loc11_.length * _loc11_.bytesPerElement;
               _loc12_ = Bytes.alloc(_loc11_.byteLength);
               _loc11_.buffer = _loc12_;
               _loc11_.copyFromArray(_loc13_);
               _loc10_ = _loc11_;
            }
            else if(_loc8_ != null)
            {
               _loc11_ = new ArrayBufferView(0,1);
               _loc12_ = _loc8_.buffer;
               _loc14_ = _loc8_.length;
               _loc15_ = _loc8_.byteOffset;
               _loc16_ = _loc8_.bytesPerElement;
               _loc17_ = _loc11_.bytesPerElement;
               if(_loc8_.type != _loc11_.type)
               {
                  throw Exception.thrown("unimplemented");
               }
               _loc18_ = _loc12_.length;
               _loc19_ = _loc18_ - _loc15_;
               _loc20_ = Bytes.alloc(_loc19_);
               _loc11_.buffer = _loc20_;
               _loc11_.buffer.blit(0,_loc12_,_loc15_,_loc19_);
               _loc11_.byteLength = _loc11_.bytesPerElement * _loc14_;
               _loc11_.byteOffset = 0;
               _loc11_.length = _loc14_;
               _loc10_ = _loc11_;
            }
            else
            {
               ...
               if(int(_loc14_ % _loc11_.bytesPerElement) != 0)
               {
                  throw Exception.thrown(TAError.RangeError);
               }
               _loc15_ = _loc5_.length;
               _loc16_ = _loc11_.bytesPerElement;
               _loc17_ = _loc15_;
               if(_loc9_ == null)
               {
                  _loc17_ = _loc15_ - _loc14_;
                  if(int(_loc15_ % _loc11_.bytesPerElement) != 0)
                  {
                     throw Exception.thrown(TAError.RangeError);
                  }
                  if(_loc17_ < 0)
               ...
               {
                  _loc17_ = _loc9_ * _loc11_.bytesPerElement;
               ...
               _loc11_.buffer = _loc5_;
               _loc11_.byteOffset = _loc14_;
               _loc11_.byteLength = _loc17_;
               _loc11_.length = int(_loc17_ / _loc11_.bytesPerElement);
               _loc10_ = _loc11_;
            }
            return _loc10_;
         }
         if(param3 == null)
         {
            ...
            else
            {
               ...
               {
                  _loc17_ = _loc21_ * _loc11_.bytesPerElement;
                  _loc18_ = _loc14_ + _loc17_;
                  if(_loc18_ > _loc15_)
                  {
                     throw Exception.thrown(TAError.RangeError);
         ...
         else
         {
            ...
            {
               _loc17_ = param3 * _loc11_.bytesPerElement;
               _loc18_ = _loc14_ + _loc17_;
               if(_loc18_ > _loc15_)
               {
                  throw Exception.thrown(TAError.RangeError);
      ...
      public static function toString(param1:ArrayBufferView) : String
      {
         if(param1 != null)
         {
            return "Int8Array [byteLength:" + param1.byteLength + ", length:" + param1.length + "]";
         }
         return null;
      }
   }
