package mx.utils
{
   ...
   public class UIDUtil
   {
      ...
      public static function createUID() : String
      {
         ...
         {
            var _loc7_:* = _loc2_++;
            _loc1_[_loc7_] = ALPHA_CHAR_CODES[Math.floor(Math.random() * 16)];
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < 3)
         {
            ...
            {
               var _loc8_:* = _loc2_++;
               _loc1_[_loc8_] = ALPHA_CHAR_CODES[Math.floor(Math.random() * 16)];
               _loc4_++;
            }
            _loc3_++;
         }
         ...
         {
            _loc8_ = _loc2_++;
            _loc1_[_loc8_] = _loc6_.charCodeAt(_loc3_);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < 4)
      ...
      public static function fromByteArray(param1:ByteArray) : String
      {
         ...
         if(param1 != null && param1.length >= 16 && param1.bytesAvailable >= 16)
         {
            ...
            while(_loc4_ < 16)
            {
               ...
               _loc6_ = _loc3_++;
               _loc2_[_loc6_] = ALPHA_CHAR_CODES[(_loc5_ & 240) >>> 4];
               var _loc7_:* = _loc3_++;
               _loc2_[_loc7_] = ALPHA_CHAR_CODES[_loc5_ & 15];
               _loc4_++;
            }
         ...
         else
         {
            ...
            try
            {
               ...
               else
               {
                  ...
                  result = String(uidDictionary[item]);
                  if(!result)
                  {
                     result = createUID();
                     try
