package mx.resources
{
   ...
   public class ResourceManagerImpl extends EventDispatcher implements IResourceManager
   {
      ...
      public function installCompiledResourceBundles(param1:ApplicationDomain, param2:Array, param3:Array, param4:Boolean = false) : Array
      {
         ...
         var _loc13_:IResourceBundle = null;
         var _loc5_:Array = [];
         var _loc6_:uint = 0;
         var _loc7_:int = Boolean(param2) ? int(param2.length) : 0;
         var _loc8_:int = Boolean(param3) ? int(param3.length) : 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc7_)
         {
            _loc10_ = String(param2[_loc9_]);
            _loc11_ = 0;
            while(_loc11_ < _loc8_)
            {
               _loc12_ = String(param3[_loc11_]);
               _loc13_ = this.installCompiledResourceBundle(param1,_loc10_,_loc12_,param4);
               if(Boolean(_loc13_))
               {
                  var _loc14_:* = _loc6_++;
                  _loc5_[_loc14_] = _loc13_;
               }
               _loc11_++;
            }
            _loc9_++;
      ...
      private function installCompiledResourceBundle(param1:ApplicationDomain, param2:String, param3:String, param4:Boolean = false) : IResourceBundle
      {
         ...
         var _loc9_:String = param2 + "$" + _loc6_ + "_properties";
         if(_loc5_ != null)
         {
      ...
      private function processInfo(param1:Object, param2:Boolean) : Array
      {
         ...
         ResourceBundle.mx_internal::locale = _loc3_ != null && _loc3_.length > 0 ? String(_loc3_[0]) : "en_US";
         var _loc4_:String = String(SystemManagerGlobals.parameters["localeChain"]);
      ...
      public function unloadResourceModule(param1:String, param2:Boolean = true) : void
      {
         ...
         if(Boolean(_loc3_.resourceModule))
         {
      ...
      {
         var _loc3_:String = String(param1.locale);
         var _loc4_:String = String(param1.bundleName);
      ...
      public function findResourceBundleWithResource(param1:String, param2:String) : IResourceBundle
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc5_ = String(this.localeChain[_loc4_]);
