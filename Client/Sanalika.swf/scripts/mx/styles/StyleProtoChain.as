package mx.styles
{
   ...
   public class StyleProtoChain
   {
      ...
      public static function getClassStyleDeclarations(param1:IStyleClient) : Array
      {
         ...
         var _loc3_:Boolean = Boolean(_loc2_.qualifiedTypeSelectors);
         var _loc4_:String = _loc3_ ? getQualifiedClassName(param1) : String(param1.className);
         ...
         while(_loc10_ >= 0)
         {
            _loc11_ = String(_loc7_[_loc10_].toString());
            if(Boolean(_loc2_.hasAdvancedSelectors()) && _loc5_ != null)
            {
      ...
      public static function initProtoChain(param1:IStyleClient, param2:Boolean = true) : void
      {
         ...
         if(Boolean(_loc12_) && Boolean(_loc12_.effects))
         {
         ...
         if(Boolean(_loc3_.hasAdvancedSelectors()) && _loc7_ != null)
         {
            ...
            while(_loc5_ < _loc4_)
            {
               ...
               if(Boolean(_loc8_.mx_internal::effects))
               {
         ...
         else
         {
            if(_loc10_)
            {
               ...
               _loc4_ = int(_loc17_.length);
               _loc5_ = 0;
               while(_loc5_ < _loc4_)
               {
                  if(Boolean(_loc17_[_loc5_].length))
                  {
         ...
         param1.inheritingStyles = Boolean(_loc8_) ? _loc8_.mx_internal::addStyleToProtoChain(_loc15_,_loc6_) : _loc15_;
         param1.nonInheritingStyles = Boolean(_loc8_) ? _loc8_.mx_internal::addStyleToProtoChain(_loc12_,_loc6_) : _loc12_;
      }
      ...
      public static function initProtoChainForUIComponentStyleName(param1:IStyleClient) : void
      {
         ...
         while(_loc9_ < _loc8_)
         {
            ...
            _loc5_ = addProperties(_loc5_,_loc3_,false);
            if(Boolean(_loc10_.mx_internal::effects))
            {
               param1.registerEffects(_loc10_.mx_internal::effects);
            }
            _loc9_++;
         }
         param1.inheritingStyles = Boolean(param1.styleDeclaration) ? param1.styleDeclaration.mx_internal::addStyleToProtoChain(_loc6_,_loc4_) : _loc6_;
         param1.nonInheritingStyles = Boolean(param1.styleDeclaration) ? param1.styleDeclaration.mx_internal::addStyleToProtoChain(_loc5_,_loc4_) : _loc5_;
      }
      ...
      private static function addProperties(param1:Object, param2:IStyleClient, param3:Boolean) : Object
      {
         ...
         if(_loc7_ != null && Boolean(_loc11_.hasAdvancedSelectors()))
         {
         ...
         else
         {
            ...
            if(Boolean(_loc8_))
            {
               ...
               else
               {
                  ...
                  {
                     if(Boolean(_loc14_[_loc15_].length))
                     {
         ...
         if(Boolean(param2.styleDeclaration))
         {
      ...
      public static function initTextField(param1:IUITextField) : void
      {
         ...
         if(Boolean(_loc3_))
         {
            ...
            else
            {
               ...
               {
                  if(Boolean(_loc8_[_loc9_].length))
                  {
      ...
      public static function setStyle(param1:IStyleClient, param2:String, param3:*) : void
      {
         ...
         var _loc6_:Boolean = param1.inheritingStyles != StyleProtoChain.STYLE_UNINITIALIZED;
         var _loc7_:Boolean = param1.getStyle(param2) != param3;
      ...
      {
         var _loc3_:IStyleManager2 = getStyleManager(param1);
         var _loc4_:Boolean = Boolean(_loc3_.qualifiedTypeSelectors);
