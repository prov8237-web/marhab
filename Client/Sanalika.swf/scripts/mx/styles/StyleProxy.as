package mx.styles
{
   ...
   public class StyleProxy implements IAdvancedStyleClient
   {
      ...
      {
         return Boolean(this._advancedSource) ? String(this._advancedSource.id) : null;
      }
      ...
      {
         return Boolean(this._advancedSource) ? Boolean(this._advancedSource.matchesCSSState(param1)) : false;
      }
      
      public function matchesCSSType(param1:String) : Boolean
      {
         return Boolean(this._advancedSource) ? Boolean(this._advancedSource.matchesCSSType(param1)) : false;
      }
      
      public function hasCSSState() : Boolean
      {
         return Boolean(this._advancedSource) ? Boolean(this._advancedSource.hasCSSState()) : false;
      }
   }
}
