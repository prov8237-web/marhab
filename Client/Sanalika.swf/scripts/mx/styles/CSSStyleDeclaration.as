package mx.styles
{
   ...
   public class CSSStyleDeclaration extends EventDispatcher
   {
      ...
      {
         return this.selector != null ? String(this.selector.mx_internal::getPseudoCondition()) : null;
      }
      ...
      mx_internal function equals(param1:CSSStyleDeclaration) : Boolean
      {
         ...
         if(Boolean(ObjectUtil.compare(this.mx_internal::effects,param1.mx_internal::effects)))
         {
            return false;
         }
         return true;
