package mx.effects
{
   ...
   public class EffectManager extends EventDispatcher
   {
      ...
      {
         var _loc3_:String = String(eventsForEffectTriggers[param1]);
      ...
      mx_internal static function createEffectForType(param1:Object, param2:String) : Effect
      {
         ...
         var _loc3_:String = String(effectTriggersForEvent[param2]);
         if(_loc3_ == "")
         {
            _loc3_ = param2 + "Effect";
         }
         var _loc4_:Object = param1.getStyle(_loc3_);
         if(!_loc4_)
         {
            return null;
         }
         ...
         {
            _loc6_ = Class(_loc4_);
            return new _loc6_(param1);
         }
         try
         {
            if(_loc4_ is String)
            {
               _loc8_ = param1.parentDocument;
               if(!_loc8_)
               {
         ...
         {
            _loc9_ = param1.moduleFactory.info()["currentDomain"];
            if(_loc9_.hasDefinition("mx.effects." + _loc4_))
            {
