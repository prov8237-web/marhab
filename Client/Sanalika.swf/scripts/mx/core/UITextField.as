package mx.core
{
   ...
   public class UITextField extends FlexTextField implements IAutomationObject, IIMESupport, IFlexModule, IInvalidating, ISimpleStyleClient, IToolTipManagerClient, IUITextField
   {
      ...
      {
         var _loc2_:Boolean = super.width != param1;
         super.width = param1;
         if(this.mirror)
         {
            this.validateTransformMatrix();
      ...
      {
         if(Boolean(this.styleManager.inheritingStyles[param1]))
         {
            return Boolean(this.inheritingStyles) ? this.inheritingStyles[param1] : IStyleClient(this.parent).getStyle(param1);
         }
         return Boolean(this.nonInheritingStyles) ? this.nonInheritingStyles[param1] : IStyleClient(this.parent).getStyle(param1);
      }
      ...
      public function getTextStyles() : TextFormat
      {
         ...
         var _loc4_:* = this.getStyle("kerning");
         if(_loc4_ == "auto" || _loc4_ == "on")
         {
            _loc4_ = true;
         }
