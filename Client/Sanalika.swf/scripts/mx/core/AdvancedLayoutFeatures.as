package mx.core
{
   ...
   public class AdvancedLayoutFeatures implements IAssetLayoutFeatures
   {
      ...
      {
         return this.layout.is3D || this.postLayoutTransformOffsets != null && Boolean(this.postLayoutTransformOffsets.mx_internal::is3D);
      }
      ...
      public function transformPointToParent(param1:Boolean, param2:Vector3D, param3:Vector3D, param4:Vector3D) : void
      {
         ...
         tempLocalPosition = Boolean(param2) ? param2.clone() : new Vector3D();
         if(this.is3D || param1)
         {
            if(param3 != null)
            {
