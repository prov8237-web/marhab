package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      private function get usingBridge() : Boolean
      {
         ...
         if(Boolean(_loc1_.useSWFBridge()))
         {
            this._usingBridge = 1;
            return true;
         }
      ...
      {
         return Boolean(this.mx_internal::_owner) ? this.mx_internal::_owner : this.parent;
      }
      ...
      override public function get parent() : DisplayObjectContainer
      {
         try
         {
            return Boolean(this.mx_internal::_parent) ? this.mx_internal::_parent : super.parent;
         }
      ...
      override public function set width(param1:Number) : void
      {
         ...
         if(this.mx_internal::_width != param1)
         {
            ...
            if(Boolean(this.mx_internal::_layoutFeatures))
            {
      ...
      public function set designLayer(param1:DesignLayer) : void
      {
         ...
         this.mx_internal::$alpha = Boolean(this._designLayer) ? this._alpha * this._designLayer.effectiveAlpha : this._alpha;
         this.mx_internal::$visible = Boolean(this.designLayer) ? this._visible && this._designLayer.effectiveVisibility : this._visible;
      }
      ...
      public function get parentApplication() : Object
      {
         ...
         if(_loc1_ == this)
         {
            ...
            _loc1_ = Boolean(_loc2_) ? _loc2_.systemManager.document : null;
         }
         return _loc1_;
      }
      ...
      {
         var _loc1_:ISystemManager = this.systemManager;
         return Boolean(_loc1_) ? _loc1_.screen : null;
      }
      ...
      public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         if(this.mx_internal::advanceStyleClientChildren != null)
         {
            ...
            {
               _loc6_ = _loc5_ as IFlexModule;
               if(Boolean(_loc6_) && (_loc6_.moduleFactory == null || _loc6_.moduleFactory == this._moduleFactory))
               {
      ...
      private function setBorderColorForErrorString() : void
      {
         ...
         if(_loc1_)
         {
            ...
            _loc3_ = Boolean(_loc2_) ? DisplayObject(_loc2_.getFocus()) : null;
      ...
      mx_internal function addingChild(param1:DisplayObject) : void
      {
         ...
         {
            IUIComponent(param1).document = Boolean(this.document) ? this.document : FlexGlobals.topLevelApplication;
         }
      ...
      public function invalidateProperties() : void
      {
         if(!this.mx_internal::invalidatePropertiesFlag)
         {
            ...
            if(Boolean(this.nestLevel) && Boolean(UIComponentGlobals.mx_internal::layoutManager))
            {
               UIComponentGlobals.mx_internal::layoutManager.invalidateProperties(this);
            }
         }
      ...
      private function invalidateTransform() : void
      {
         if(Boolean(this.mx_internal::_layoutFeatures) && this.mx_internal::_layoutFeatures.updatePending == false)
         {
            ...
            if(this.nestLevel && UIComponentGlobals.mx_internal::layoutManager && this.mx_internal::invalidateDisplayListFlag == false)
            {
               UIComponentGlobals.mx_internal::layoutManager.invalidateDisplayList(this);
            }
         }
      ...
      public function invalidateLayoutDirection() : void
      {
         ...
         var _loc3_:Boolean = Boolean(_loc1_) ? _loc1_.layoutDirection != _loc2_ : LayoutDirection.LTR != _loc2_;
         if(Boolean(this.mx_internal::_layoutFeatures) ? _loc3_ != this.mx_internal::_layoutFeatures.mirror : _loc3_)
         {
            if(this.mx_internal::_layoutFeatures == null)
            {
               this.initAdvancedLayoutFeatures();
         ...
         if(this.mx_internal::oldLayoutDirection != this.layoutDirection)
         {
            ...
            {
               _loc5_ = IVisualElementContainer(this);
               _loc6_ = int(_loc5_.numElements);
               _loc4_ = 0;
               while(_loc4_ < _loc6_)
               {
                  _loc7_ = _loc5_.getElementAt(_loc4_);
                  if(Boolean(_loc7_) && !(_loc7_ is IStyleClient))
                  {
            ...
            else
            {
               ...
               while(_loc4_ < _loc8_)
               {
                  ...
                  if(!(_loc9_ is IStyleClient) && _loc9_ is ILayoutDirectionElement)
                  {
      ...
      public function validateSize(param1:Boolean = false) : void
      {
         ...
         if(this.mx_internal::invalidateSizeFlag)
         {
            _loc4_ = this.mx_internal::measureSizes();
      ...
      public function getFocus() : InteractiveObject
      {
         ...
         if(Boolean(UIComponentGlobals.mx_internal::nextFocusObject))
         {
            return UIComponentGlobals.mx_internal::nextFocusObject;
         }
         if(Boolean(_loc1_.stage))
         {
      ...
      public function drawFocus(param1:Boolean) : void
      {
         ...
         var _loc3_:Sprite = Boolean(this.focusManager) ? this.focusManager.focusPane : null;
      ...
      {
         return this is IStateClient2 && this.states.length > 0 ? String(this.states[0].name) : null;
      }
      ...
      private function commitCurrentState() : void
      {
         ...
         var _loc4_:String = Boolean(this._currentState) ? this._currentState : "";
         ...
         if(Boolean(this._currentTransition))
         {
            ...
            {
               _loc6_ = this._currentTransition.effect;
               _loc6_.transitionInterruption = true;
         ...
         if(hasEventListener(StateChangeEvent.CURRENT_STATE_CHANGING))
         {
            ...
            _loc3_.newState = Boolean(this.requestedCurrentState) ? this.requestedCurrentState : "";
         ...
         if(hasEventListener(StateChangeEvent.CURRENT_STATE_CHANGE))
         {
            ...
            _loc3_.oldState = _loc4_;
            _loc3_.newState = Boolean(this._currentState) ? this._currentState : "";
            this.dispatchEvent(_loc3_);
         }
         if(Boolean(_loc1_))
         {
      ...
      private function getState(param1:String, param2:Boolean = true) : State
      {
         ...
         if(param2)
         {
            _loc4_ = String(this.resourceManager.getString("core","stateUndefined",[param1]));
      ...
      public function regenerateStyleCache(param1:Boolean) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            {
               if(Boolean(IUITextField(_loc5_).inheritingStyles))
               {
         ...
         if(this.mx_internal::advanceStyleClientChildren != null)
         {
            for(_loc6_ in this.mx_internal::advanceStyleClientChildren)
            {
               ...
               if(Boolean(_loc7_) && _loc7_.inheritingStyles != StyleProtoChain.STYLE_UNINITIALIZED)
               {
      ...
      {
         if(this.currentCSSState && param1 != param2 && (Boolean(this.styleManager.hasPseudoCondition(param1)) || Boolean(this.styleManager.hasPseudoCondition(param2))))
         {
      ...
      public function getStyle(param1:String) : *
      {
         ...
         return Boolean(this.styleManager.inheritingStyles[param1]) ? this._inheritingStyles[param1] : this._nonInheritingStyles[param1];
      }
      ...
      public function addStyleClient(param1:IAdvancedStyleClient) : void
      {
         ...
         _loc3_ = String(this.resourceManager.getString("core","badParameter",[param1]));
      ...
      public function determineTextFormatFromStyles() : UITextFormat
      {
         ...
         if(!_loc1_)
         {
            ...
            _loc3_ = String(this._inheritingStyles.textAlign);
            if(_loc3_ == "start")
            {
      ...
      mx_internal function getFontContext(param1:String, param2:Boolean, param3:Boolean, param4:* = undefined) : IFlexModuleFactory
      {
         ...
         return Boolean(_loc5_) ? _loc5_.getAssociatedModuleFactory(param1,param2,param3,this,this.moduleFactory,this.systemManager,param4) : null;
      }
      ...
      protected function createInFontContext(param1:Class) : Object
      {
         ...
         var _loc8_:IFlexModuleFactory = Boolean(this.oldEmbeddedFontContext) ? this.oldEmbeddedFontContext : this.moduleFactory;
      ...
      public function hasFontContextChanged() : Boolean
      {
         ...
         var _loc4_:Boolean = _loc2_ == "bold";
         var _loc5_:Boolean = _loc3_ == "italic";
      ...
      public function getVisibleRect(param1:DisplayObject = null) : Rectangle
      {
         ...
         var _loc2_:DisplayObject = Boolean(this.mx_internal::$parent) ? this.mx_internal::$parent : this.parent;
         if(!_loc2_)
         {
         ...
         do
         {
            ...
            {
               if(Boolean(UIComponent(_loc5_).mx_internal::$parent))
               {
      ...
      {
         var _loc2_:mx.geom.Transform = this._transform as Transform;
         if(Boolean(_loc2_))
         {
            _loc2_.target = null;
         }
         var _loc3_:mx.geom.Transform = param1 as Transform;
         if(Boolean(_loc3_))
         {
            _loc3_.target = this;
         }
      ...
      override public function set transform(param1:flash.geom.Transform) : void
      {
         ...
         var _loc7_:mx.geom.Transform = param1 as Transform;
         if(Boolean(_loc7_))
         {
      ...
      {
         var _loc3_:Matrix = Boolean(this.mx_internal::_layoutFeatures) ? this.mx_internal::_layoutFeatures.layoutMatrix : super.transform.matrix;
         ...
         if(MatrixUtil.isEqual(_loc3_,Boolean(this.mx_internal::_layoutFeatures) ? this.mx_internal::_layoutFeatures.layoutMatrix : super.transform.matrix))
         {
            return;
         }
         this.invalidateProperties();
      ...
      {
         return Boolean(this.mx_internal::_layoutFeatures) ? this.mx_internal::_layoutFeatures.computedMatrix : this.transform.matrix;
      }
      ...
      {
         return Boolean(this.mx_internal::_layoutFeatures) ? this.mx_internal::_layoutFeatures.layoutIs3D : false;
      }
      
      public function get is3D() : Boolean
      {
         return Boolean(this.mx_internal::_layoutFeatures) ? this.mx_internal::_layoutFeatures.is3D : false;
      }
