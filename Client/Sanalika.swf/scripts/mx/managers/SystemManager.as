   ...
   public class SystemManager extends MovieClip implements IChildList, IFlexDisplayObject, IFlexModuleFactory, ISystemManager
   {
      ...
      public static function getSWFRoot(param1:Object) : DisplayObject
      {
         ...
         for(_loc3_ in mx_internal::allSystemManagers)
         {
            ...
            _loc5_ = _loc4_.loaderInfo.applicationDomain;
            try
            {
      ...
      {
         return Boolean(this.mx_internal::topLevelWindow) ? Number(this.mx_internal::topLevelWindow.getExplicitOrMeasuredHeight()) : loaderInfo.height;
      }
      
      public function get measuredWidth() : Number
      {
         return Boolean(this.mx_internal::topLevelWindow) ? Number(this.mx_internal::topLevelWindow.getExplicitOrMeasuredWidth()) : loaderInfo.width;
      }
      ...
      public function create(... rest) : Object
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc2_:String = String(this.info()["mainClassName"]);
         if(_loc2_ == null)
         {
         ...
         return Boolean(_loc3_) ? new _loc3_() : null;
      }
      ...
      mx_internal function initialize() : void
      {
         ...
         if(Boolean(_loc3_) && _loc3_.length > 0)
         {
            ...
            _loc7_ = int(this.rslDataList.length);
            _loc8_ = 0;
            while(_loc8_ < _loc7_)
            {
         ...
         var _loc9_:String = String(loaderInfo.parameters["resourceModuleURLs"]);
         var _loc10_:Array = Boolean(_loc9_) ? _loc9_.split(",") : null;
      ...
      {
         var _loc2_:Vector.<RSLData> = null;
      ...
      public function getTopLevelRoot() : DisplayObject
      {
         ...
         {
            _loc1_ = this;
            if(Boolean(_loc1_.topLevelSystemManager))
            {
      ...
      public function getVisibleApplicationRect(param1:Rectangle = null, param2:Boolean = false) : Rectangle
      {
         ...
         if(!param1)
         {
            ...
            _loc5_ = this.screen.clone();
            _loc5_.topLeft = _loc4_.localToGlobal(this.screen.topLeft);
